...
$sql = "SELECT iCancelReasonId,iSortId,eStatus,eAllowedCharge,vTitle_".$default_lang." as vTitle from cancel_reason WHERE eStatus != 'Deleted' $ssql $dri_ssql $ord LIMIT $start, $per_page";
