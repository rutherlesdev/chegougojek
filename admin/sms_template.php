...
if(!$userObj->hasPermission('view-sms-templates')){
  $userObj->redirect();
}
...
$sql = "SELECT COUNT(iSendMessageId) AS Total FROM send_message_templates WHERE  eStatus = 'Active' $ssql";
...
<!--                                    <div class="panel-heading">
                    ...
                    <div class="admin-notes">
                            ...
                            <ul>
                                    <li>
                                            SMS Templates module will list all SMS on this page.
                                    </li>
                                    <li>
                                            Administrator can edit any SMS template. 
                                    </li>
<!--                                     <li>
