                    ...
                    <div class="admin-notes">
                        ...
                        <ul>
                            ...
                            <li> PromoCode Type : <br>
                                 Public  : If the Admin User selects PromoCode Type as â€œPublicâ€? then all the User in entire system would be able to see the respective PromoCode in the apps while trying to apply the PromoCode. <br/>
                                 Private : If the Admin User selects PromoCode Type as â€œPrivateâ€? the respective PromoCode would not be visible to the in the apps while trying to apply the PromoCode. However, if the admin shares the private PromoCode with any of the user by any mode that promocode would be applied if itâ€™s a valid.
                             </li>
                        </ul>
                    </div>
