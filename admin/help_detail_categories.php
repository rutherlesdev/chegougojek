...
if (!$userObj->hasPermission('view-help-detail-category')) {
    $userObj->redirect();
}
...
<?php include('valid_msg.php'); ?>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td width="10%" class=" padding-right10"><select name="option" id="option" class="form-control">
                                            ...
                                            <option  value="vTitle" <?php if ($option == "vTitle") {
    echo "selected";
} ?> >Title</option>
                                            <option value="iDisplayOrder" <?php if ($option == 'iDisplayOrder') {
    echo "selected";
} ?> >Order</option>
    ...
    echo "selected";
                                    ...
                                    <?php if ($userObj->hasPermission('create-help-detail-category')) { ?>
...
<?php } ?>
                                ...
                                <div class="admin-nir-export">
                                    <div class="changeStatus col-lg-12 option-box-left">
                                        <span class="col-lg-2 new-select001">
                                                <?php if ($userObj->hasPermission(['update-status-help-detail-category', 'delete-help-detail-category'])) { ?>
                                                <select name="changeStatus" id="changeStatus" class="form-control" onchange="ChangeStatusAll(this.value);">
                                                    <option value="" >Select Action</option>
                                                    <?php if ($userObj->hasPermission('update-status-help-detail-category')) { ?>
    ...
    <?php } ?>
                                        <?php if ($userObj->hasPermission('delete-help-detail-category')) { ?>
...
<?php } ?>
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th width="20%"><a href="javascript:void(0);" onClick="Redirect(2,<?php if ($sortby == '2') {
                                                        echo $order;
                                                    } else { ?>0<?php } ?>)">Title <?php if ($sortby == 2) {
                                                ...
                                                <? if (DELIVERALL == 'Yes') { ?>
                                                        <th>Help Category For</th>
                                                <? } ?>
                                                    <th width="20%" class="align-center"><a href="javascript:void(0);" onClick="Redirect(3,<?php if ($sortby == '3') {
                                                    echo $order;
        ...
        ?>
            ...
            <?php if ($userObj->hasPermission('update-status-help-detail-category')) { ?>
                                                                                    <li class="entypo-facebook" data-network="facebook"><a href="javascript:void(0);" onclick="changeStatus('<?= $iUniqueId; ?>', 'Inactive')"  data-toggle="tooltip" title="Activate">
                                                                                            <img src="img/active-icon.png" alt="<?php echo $data_drv[$i]['eStatus']; ?>" >
                                                                                        </a></li>
                                                                                    <li class="entypo-gplus" data-network="gplus"><a href="javascript:void(0);" onclick="changeStatus('<?= $iUniqueId; ?>', 'Active')" data-toggle="tooltip" title="Deactivate">
                                                                                            <img src="img/inactive-icon.png" alt="<?php echo $data_drv[$i]['eStatus']; ?>" >	
                                                                                        </a></li>
            <?php } ?>
            <?php if ($userObj->hasPermission('delete-help-detail-category')) { ?>
                                                                                    <li class="entypo-gplus" data-network="gplus"><a href="javascript:void(0);" onclick="changeStatusDelete('<?= $iUniqueId; ?>')"  data-toggle="tooltip" title="Delete"> <img src="img/delete-icon.png" alt="Delete" > </a></li>
            <?php } ?>
        <?php } ?>
                                                                        </ul>
                                                                    </div>
