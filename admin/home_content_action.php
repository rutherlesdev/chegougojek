...
if ($APP_TYPE == "Ride" || $APP_TYPE == "Ride-Delivery") {
    require_once('home_content_action_ride.php');
    exit;
}
                            ...
                            <form method="post" name="_home_content_form" id="_home_content_form" action="" enctype='multipart/form-data'>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <?php if ($third_mid_image_one != '') { ?>
                                                    <img src="<?= $tconfig["tsite_upload_apptype_page_images"] . $template . "/" . $third_mid_image_one; ?>" class="innerbg_image"/>
                                                <?php } ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <?php if ($mobile_app_bg_img != '') { ?>
                                                    <img src="<?= $tconfig["tsite_upload_apptype_page_images"] . $template . "/" . $mobile_app_bg_img; ?>" class="innerbg_image"/>
                                                <?php } ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <?php if ($mobile_app_left_img != '') { ?>
                                                    <img src="<?= $tconfig["tsite_upload_apptype_page_images"] . $template . "/" . $mobile_app_left_img; ?>" class="innerbg_image"/>
                                                <?php } ?>
                                ...
                                <div class="body-div innersection">
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <label>Home <?php echo $langage_lbl_admin['LBL_DRIVER_TXT_ADMIN']; ?> Section First Label <span class="red"> *</span></label>
                                            </div>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" name="driver_sec_first_label"  id="driver_sec_first_label" value="<?= $driver_sec_first_label; ?>" placeholder="Home <?php echo $langage_lbl_admin['LBL_DRIVER_TXT_ADMIN']; ?> Section First Label" required>
                                            </div>
                                        </div>

                                        <div class="row">
                                            <div class="col-lg-12">
                                                <label>Home <?php echo $langage_lbl_admin['LBL_DRIVER_TXT_ADMIN']; ?> Section Second Label <span class="red"> *</span></label>
                                            </div>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" name="driver_sec_second_label"  id="driver_sec_second_label" value="<?= $driver_sec_second_label; ?>" placeholder="Home <?php echo $langage_lbl_admin['LBL_DRIVER_TXT_ADMIN']; ?> Section Second Label" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
