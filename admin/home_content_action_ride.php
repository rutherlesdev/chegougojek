                            ...
                            <form method="post" name="_home_content_form" id="_home_content_form" action="" enctype='multipart/form-data'>
                                ...
                                <div class="body-div innersection">
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <label>Home Forth Section Icon Image<span class="red"> *</span></label>
                                            </div>
                                            <div class="col-lg-6">
                                                <?php if ($third_mid_image_three != '') { ?>
                                                    <img src="<?= $tconfig["tsite_upload_apptype_page_images"] . $template . "/" . $third_mid_image_three; ?>" class="innerbg_image" width="50" height="50" style="height:50px;"/>
                                                <?php } ?>
