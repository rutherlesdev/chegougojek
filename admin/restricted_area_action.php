<?php
	...
	if(isset($_POST['submit'])) {
		...
		if($action == "Add" && !$userObj->hasPermission('create-restricted-area')){
	        $_SESSION['success'] = 3;
	    ...
	    if($action == "Edit" && !$userObj->hasPermission('edit-restricted-area')){
	        $_SESSION['success'] = 3;
					...
					<div class="body-div">
						<div class="form-group">
							<? if($success == 1) { ?>
								...
								<div class="row">
									<div class="col-lg-12">
										<?php if(($action == 'Edit' && $userObj->hasPermission('edit-restricted-area')) || ($action == 'Add' &&  $userObj->hasPermission('create-restricted-area'))){ ?>
											<input type="submit" class="btn btn-default" name="submit" id="submit" value="<?php  if($action=='Add'){?><?= $action; ?> Area<?php } else{ ?>Update<?php } ?>" >
										<?php } ?>
