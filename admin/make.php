...
if (!$userObj->hasPermission('view-vehicle-make')) {
    $userObj->redirect();
}
...
if ($hdn_del_id != '') {
    if (SITE_TYPE != 'Demo') {
        ...
        header("Location:make.php?success=2");
        exit;
    }
}
if ($iMakeId != '' && $status != '') {
...
<?php include('valid_msg.php'); ?>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td width="10%" class=" padding-right10"><select name="option" id="option" class="form-control">
                                            ...
                                            <option value="vMake" <?php if ($option == "vMake") {
    echo "selected";
} ?> >Make</option>
    ...
    echo "selected";
                                    ...
                                    <?php if ($userObj->hasPermission('create-vehicle-make')) { ?>
                                ...
                                <div class="admin-nir-export">
                                    <div class="changeStatus col-lg-12 option-box-left">
                                        <span class="col-lg-2 new-select001">
                                            <?php if ($userObj->hasPermission(['update-status-vehicle-make', 'delete-vehicle-make'])) { ?>
                                                <select name="changeStatus" id="changeStatus" class="form-control" onchange="ChangeStatusAll(this.value);">
                                                    <option value="" >Select Action</option>
                                                    <?php if ($userObj->hasPermission('update-status-vehicle-make')) { ?>
                                                ...
                                                <?php } ?>
                                                <?php if ($userObj->hasPermission('delete-vehicle-make')) { ?>
                                    ...
                                    <?php if (!empty($data_drv)) { ?>
                                        <!--                                    <div class="panel-heading">
                                                                                <form name="_export_form" id="_export_form" method="post" >
                                                                                     <a href="make_import.php" class="btn btn-default"> Import </a>
...
<?php } ?>
    ...
    echo $order;
} else { ?>0<?php } ?>)">Make<?php if ($sortby == 1) {
        ...
        ?>
                                                            ...
                                                            <td align="center" style="text-align:center;" class="action-btn001">
                                                                <div class="share-button openHoverAction-class" style="display: block;">
                                                                    ...
                                                                    <div class="social show-moreOptions leastcol openPops_<?= $data_drv[$i]['iMakeId']; ?>">
                                                                        <ul>
                                                        ...
                                                        <?php if ($data_drv[$i]['eDefault'] != 'Yes') { ?>
                                                            <?php if ($userObj->hasPermission('update-status-vehicle-make')) { ?>
                                                                                    <li class="entypo-facebook" data-network="facebook"><a href="javascript:void(0);" onclick="changeStatus('<?php echo $data_drv[$i]['iMakeId']; ?>', 'Inactive')"  data-toggle="tooltip" title="Activate">
                                                                                            <img src="img/active-icon.png" alt="<?php echo $data_drv[$i]['eStatus']; ?>" >
                                                                                        </a></li>
                                                                                    <li class="entypo-gplus" data-network="gplus"><a href="javascript:void(0);" onclick="changeStatus('<?php echo $data_drv[$i]['iMakeId']; ?>', 'Active')" data-toggle="tooltip" title="Deactivate">
                                                                                            <img src="img/inactive-icon.png" alt="<?php echo $data_drv[$i]['eStatus']; ?>" >	
                                                                                        </a></li>
                                                <?php } ?>
                                                <?php if ($userObj->hasPermission('delete-vehicle-make')) { ?>
                                                                                    <li class="entypo-gplus" data-network="gplus"><a href="javascript:void(0);" onclick="changeStatusDelete('<?php echo $data_drv[$i]['iMakeId']; ?>')"  data-toggle="tooltip" title="Delete"> <img src="img/delete-icon.png" alt="Delete" > </a></li>
            <?php } ?>
        <?php } ?>
                                                                        </ul>
                                                                    </div>
...
<?php include('pagination_n.php'); ?>
                    ...
                    <div class="admin-notes">
                        <h4>Notes:</h4>
                        <ul>
                            <li> Make module will list all makes on this page. </li>
                            <li> Administrator can Activate / Deactivate / Delete any make. </li>
