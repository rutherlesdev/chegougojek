...
if(!$userObj->hasPermission('view-our-provider')){
  $userObj->redirect();
}
            ...
            <div id="content">
                <div class="inner">
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="admin-nir-table">
							<tbody>
                                <tr>
									...
									<?php if($userObj->hasPermission('create-our-provider')){ ?>
														...
														<tr class="gradeA">
															...
															<td align="center" style="text-align:center;">
																<?php if ($data_drv[$i]['eStatus'] != 'Yes') {?>
																	...
																	<?php } else { ?><img src="img/active-icon.png" alt="image" data-toggle="tooltip" title="<?=$data_drv[$i]['eStatus'];?>">
																<?php } ?>
															</td>
																...
																<div class="social show-moreOptions openPops_<?=$data_drv[$i]['iDriverId'];?>">
																	<ul>
																		...
																		<?php if ($data_drv[$i]['eDefault'] != 'Yes') { ?>
																			<?php if($userObj->hasPermission('update-status-our-provider')){ ?>
																			...
																			<?php } ?>
																			<?php if($userObj->hasPermission('delete-our-provider')){ ?>
                    ...
                    <div class="admin-notes">
						...
						<ul>
							<li>
								Home page <?php echo strtolower($langage_lbl_admin['LBL_DRIVER_TXT_ADMIN']); ?> module will list all home page <?php echo strtolower($langage_lbl_admin['LBL_DRIVERS_NAME_ADMIN']); ?> on this page.
							</li>
							<li>
								Administrator can Activate / Deactivate / Delete any home page <?php echo strtolower($langage_lbl_admin['LBL_DRIVER_TXT_ADMIN']); ?>.
							</li>
							<li>
