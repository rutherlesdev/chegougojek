...
if (isset($_POST['submit'])) {
	...
	else
	{
        ...
        @unlink($img_path . '/' . $id. '/4_' . $oldImage);
			}
			...
			/*if($img1!=''){
				if(is_file($Photo_Gallery_folder.$img1)) {
				   ...
				   $img1 = $generalobj->img_data_upload($Photo_Gallery_folder,$img1,$Photo_Gallery_folder, $tconfig["tsite_upload_images_hotel_passenger_size1"], $tconfig["tsite_upload_images_hotel_passenger_size2"], $tconfig["tsite_upload_images_hotel_passenger_size3"],$tconfig["tsite_upload_images_hotel_passenger_size4"]);
				}
			}             */
			$vImgName = $img1;
