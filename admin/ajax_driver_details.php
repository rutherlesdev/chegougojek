...
<div class="modal-footer">
    <? if ($_SESSION['SessionUserType'] != 'hotel') { ?>
        <a href="driver_action.php?id=<?= $iDriverId; ?>" class="btn btn-primary btn-ok" target="blank">Edit <?= $langage_lbl_admin['LBL_DRIVER_TXT_ADMIN'] ?></a>
    <? } ?>
