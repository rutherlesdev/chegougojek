                                    ...
                                    <div class="changeStatus col-lg-12 option-box-left">
                                        <span class="col-lg-2 new-select001">
                                                ...
                                                <select name="changeStatus" id="changeStatus" class="form-control" onchange="ChangeStatusAll(this.value);">
                                                    ...
                                                    ?> >Deactivate</option>
                                        <?php } ?>
    <?php if ($eStatus != 'Deleted' && $userObj->hasPermission('delete-country')) { ?>
                                                        <option value="Deleted" <?php
        if ($option == 'Delete') {
            echo "selected";
        }
                                        ...
                                        <table class="table table-striped table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <?php if(COUNTRY_IMAGE_UPLOAD=='Yes') { ?><th align="center" width="3%" style="text-align:center;">Flag</th><?php } ?>
                                                    <th width="20%"><a href="javascript:void(0);" onClick="Redirect(1,<?php
                                                                                                                if ($sortby == '1') {
                                                                                                                    echo $order;
                                                                                                                } else {
                                                                                                                    ?>0<?php } ?>)">Country <?php if ($sortby == 1) {
                                                            if ($order == 0) {
                                            ...
                                            if ($sortby == '3') {
                                                ...
                                                ?>0<?php } ?>)">Unit(Miles/KMs) <?php if ($sortby == 3) {
                                                if ($order == 0) {
                                                        ?><i class="fa fa-sort-amount-asc" aria-hidden="true"></i> <?php } else { ?><i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php }
                                                } else {
                                                    ?><i class="fa fa-sort" aria-hidden="true"></i> <?php } ?></a></th>
                                            ...
                                            <tbody>
                                                        ...
                                                        <tr class="gradeA">
                                                            ...
                                                            <?php if(COUNTRY_IMAGE_UPLOAD=='Yes') { ?>
    <td style="text-align:center;"><?php  if(!empty($data_drv[$i]['vSImage']) && file_exists($tconfig["tsite_upload_country_images_path"].$data_drv[$i]['vSImage'])) { ?>
        <!-- <img src="<?=$tconfig["tsite_upload_country_images"].$data_drv[$i]['vSImage']?>" width="20" height="20"> -->
        <img src="<?= $tconfig["tsite_url"].'resizeImg.php?w=40&h=40&src='.$tconfig["tsite_upload_country_images"].$data_drv[$i]['vSImage'] ?>" width="20" height="20">
        <?php } else { ?>
        <!-- <img src="<?=$tconfig["tsite_url"] ."webimages/icons/DefaultImg/in_s.png"?>" width="20" height="20"> -->
        <img src="<?= $tconfig['tsite_url'].'resizeImg.php?w=40&h=40&src='.$tconfig['tsite_url'] .'webimages/icons/DefaultImg/in_s.png' ?>" width="20" height="20">
