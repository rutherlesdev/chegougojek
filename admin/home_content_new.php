...
if ($id != '' && $status != '') {
    if (SITE_TYPE != 'Demo') {
        ...
        header("Location:home_content_new.php?success=2");
        exit;
    }
}
...
if ($page <= 0)
    $page = 1;
//Pagination End
$sql = "SELECT hc.*,lm.vTitle FROM homecontent as hc LEFT JOIN language_master as lm on lm.vCode = hc.vCode WHERE 1 = 1 AND hc.eStatus = 'Active' $ssql $ord LIMIT $start, $per_page ";
                ...
                <div class="inner">
                    ...
                    ?> >Language Code</option>
                                    ...
                                    <td width="12%">
                                      ...
                                      <input type="button" value="Reset" class="btnalt button11" onClick="window.location.href='home_content_new.php'"/>
                                    </td>
                                     <td width="30%"><a class="add-btn" href="home_content_action_new.php" style="text-align: center;">Add Home Content</a></td> 
                                </tr>
                              </tbody>
                        </table>
                                                    ...
                                                    for ($i = 0; $i < count($data_drv); $i++) {
                                                        ...
                                                        <tr class="gradeA">
                                                            ...
                                                            <td align="center" style="text-align:center;" class="action-btn001">
                                                                <a href="home_content_action_new.php?id=<?= $data_drv[$i]['id']; ?>" data-toggle="tooltip" title="Edit">
...
<?php //include('pagination_n.php');    ?>
        ...
        <!--END MAIN WRAPPER -->
        <form name="pageForm" id="pageForm" action="action/home_content_new.php" method="post" >
