<?php
	...
	if(!$userObj->hasPermission('view-popular-stores')){
	  $userObj->redirect();
	}
                    ...
                    <div id="add-hide-show-div">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <h2>Popular <?=$langage_lbl_admin['LBL_RESTAURANT_TXT_ADMIN']?></h2>
							...
							<tbody>
                                <tr>
                                    ...
                                    <td width="10%" class=" padding-right10"><select name="option" id="option" class="form-control">
										...
										<option value="vCompany" <?php if ($option == "vCompany") { echo "selected"; } ?> ><?=$langage_lbl_admin['LBL_RESTAURANT_TXT_ADMIN']?> Name</option>
									...
									<?php if($userObj->hasPermission('create-popular-stores')){ ?>
                                   		<td width="30%"><a class="add-btn" href="service_provider_action.php" style="text-align: center;">Add <?=$langage_lbl_admin['LBL_RESTAURANT_TXT_ADMIN']?></a></td>
                                   	<?php } ?>
								</tr>
							</tbody>
						</table>
														...
														<tr class="gradeA">
                                                            ...
                                                            <td align="center" style="text-align:center;" class="action-btn001">
																...
																<div class="social show-moreOptions openPops_<?= $data_drv[$i]['iDriverId']; ?>">
																	<ul>
																		<li class="entypo-twitter" data-network="twitter"><a href="service_provider_action.php?id=<?= $data_drv[$i]['iDriverId']; ?>" data-toggle="tooltip" title="Edit">
