...
if($sub_cid > 0){
    ...
    if($mainParentId > 0){
        $backPage = "vehicle_sub_category.php?sub_cid=".$mainParentId;
    }
}
                    ...
                    <form name="frmsearch" id="frmsearch" action="javascript:void(0);" method="post">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="admin-nir-table">
                            ...
                            <td>
                                ...
                                <input type="button" value="Reset" class="btnalt button11" onClick="window.location.href = 'vehicle_sub_category.php?sub_cid=<?php echo $sub_cid; ?><?php if ($parent_ufx_catid == "178") { ?>&subcat=<?=
                                        $sub_cid;
                                    }
                    ?>'"/>
                            </td>
                                            ...
                                            <?php if ($userObj->hasPermission(['update-status-service-category', 'delete-service-category'])) { ?>
                                                <select name="changeStatus" id="changeStatus" class="form-control" onChange="ChangeStatusAll(this.value);">
                                                    ...
                                                    <?php if ($userObj->hasPermission('update-status-service-category')) { ?>
                                                        ...
                                                        ?> >Deactivate</option>
                                                            <?php } ?>
                                                    <?php if ($userObj->hasPermission('delete-service-category')&& $eStatus != 'Deleted') { ?>
                                                        <option value="Deleted" <?php
                                                        if ($option == 'Delete') {
                                                            echo "selected";
                                                        }
                                        ...
                                        <table class="table table-striped table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <?php } ?>
                                                    <? if ($data_cetegory_name[0]['eCatType'] != "MoreDelivery") { ?>
                                                        <th width="10%">Icon</th>
                                                    <? } else if ($data_cetegory_name[0]['eFor'] == "DeliverAllCategory" && $data_cetegory_name[0]['eCatType'] == "MoreDelivery") { ?>
                                                    ...
                                                    <th width="18%"><a href="javascript:void(0);" onClick="Redirect(1,<?php
                                                        if ($sortby == '1') {
                                                            ...
                                                            ?>0<?php } ?>)">Name <?php
                                                                ...
                                                                ?><i class="fa fa-sort" aria-hidden="true"></i> <?php } ?></a></th>										<? if ($hideColumn == 0) { ?>				
                                                            ...
                                                            <? } else if ($data_cetegory_name[0]['eFor'] == "DeliverAllCategory" && $data_cetegory_name[0]['eCatType'] == "MoreDelivery") { ?>
                                                                <td align="center">                                                            
                                                                    <? if ($data_drv[$i]['vBannerImage'] != '') { ?>                                               
                                                                        <img src="<?= $tconfig['tsite_upload_images_vehicle_category'] . "/" . $data_drv[$i]['iVehicleCategoryId'] . "/" . $data_drv[$i]['vBannerImage']; ?>" style="width:80px;height:50px;">
                                                                    <? } ?>                                                     
                                                                </td>
                                                            <? } ?>
                                                            ...
                                                            <? if ($hideColumn == 0) { ?>	
                                                                <td align="center">
                                                                    ...
                                                                    if ($data_drv[$i]['eCatType'] == 'ServiceProvider' && $parent_ufx_catid != $data_drv[$i]['iVehicleCategoryId']) {
                                                                        if ($userObj->hasPermission('view-service-type') || $userObj->hasPermission('view-service-category')) {
                                                                            ?>
                                                                            <a class="add-btn-sub" href="service_type.php?iVehicleCategoryId=<?= $data_drv[$i]['iVehicleCategoryId'] ?>" target="_blank"><?= $buttonText; ?> (<?php echo $data_drv[$i]['Servicetypes']; ?>) </a>
                                                                        <?php } else { ?>
                                                                        ...
                                                                        if ($data_cetegory_name[0]['eCatType'] == "MoreDelivery" && $data_drv[$i]['catCount'] > 0) {
                                                                            if ($parent_ufx_catid != $data_drv[$i]['iVehicleCategoryId']) {
                                                                                ?>
                                                                                <?php if ($userObj->hasPermission('view-service-type') || $userObj->hasPermission('view-service-category')) { ?>
                                                                                    <a class="add-btn-sub" href="vehicle_sub_category.php?sub_cid=<?= $data_drv[$i]['iVehicleCategoryId'] ?><?php if ($parent_ufx_catid == "178") { ?>&subcat=<?=
                                                        $data_drv[$i]['iVehicleCategoryId'];
                                                    }
                                                                                    ?>" target="_blank"><?= $buttonText; ?> (<?php echo $data_drv[$i]['catCount']; ?>) </a>
                                                                                <?php } else { ?>
                                                                    ...
                                                                    <div class="share-button openHoverAction-class" style="display: block;">
                                                                        ...
                                                                        <div class="social show-moreOptions for-five openPops_<?= $data_drv[$i]['iVehicleCategoryId']; ?>" style="left:18px;">
                                                                            ...
                                                                            <ul>
                                                                                ...
                                                                                <?php if ($userObj->hasPermission('update-status-service-category')) { ?>
                                                                                    <li class="entypo-facebook" data-network="facebook"><a href="javascript:void(0);" onClick="changeSubCatStatus('<?php echo $data_drv[$i]['iVehicleCategoryId']; ?>', 'Inactive','<?php echo $iServiceIdEdit; ?>')"  data-toggle="tooltip" title="Activate">
                                                                                            <img src="img/active-icon.png" alt="<?php echo $data_drv[$i]['eStatus']; ?>" >
                                                                                        </a></li>
                                                                                    <li class="entypo-gplus" data-network="gplus"><a href="javascript:void(0);" onClick="changeSubCatStatus('<?php echo $data_drv[$i]['iVehicleCategoryId']; ?>', 'Active','<?php echo $iServiceIdEdit; ?>')" data-toggle="tooltip" title="Deactivate">
