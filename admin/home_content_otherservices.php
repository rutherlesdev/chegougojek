...
<html lang="en">
    ...
    <head>
        <meta charset="UTF-8" />
        <title><?= $SITE_NAME ?> | Other Services Home Page</title>
                                            ...
                                            <tbody>
                                                ...
                                                if (!empty($data_drv)) {
                                                    for ($i = 0; $i < count($data_drv); $i++) {
                                                        ...
                                                        ?>
                                                        <tr class="gradeA">
                                                            <td>Other Serivce Page - <?= $data_drv[$i]['vTitle']; ?></td> 
                                                            <td align="center" style="text-align:center;" class="action-btn001">
                                                                <a href="home_content_otherservices_action.php?id=<?= $data_drv[$i]['iLanguageMasId']; ?>" data-toggle="tooltip" title="Edit">
