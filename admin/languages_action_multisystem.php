...
function updateLblValues($database, $table, $obj) {
    ...
    if (in_array($table, $taxi_tables)) {
        if (!empty($vValue_ride)) {
            ...
            $data_label_value_update['vValue'] = $generalobj->getProperDataValueWithoutClean($vValue_ride);
        ...
        if (!empty($vValue_ride_delivery)) {
            ...
            $data_label_value_update = array();
            $data_label_value_update['vValue'] = $generalobj->getProperDataValueWithoutClean($vValue_ride_delivery);
            $data_label_value_update['eAppType'] = $eAppType;
            $data_label_value_update['lPage_id'] = $lPage_id;
        ...
        if (!empty($vValue_delivery)) {
            ...
            $data_label_value_update = array();
            $data_label_value_update['vValue'] = $generalobj->getProperDataValueWithoutClean($vValue_delivery);
            $data_label_value_update['eAppType'] = $eAppType;
            $data_label_value_update['lPage_id'] = $lPage_id;
        ...
        if (!empty($vValue_uberx)) {
            ...
            $data_label_value_update = array();
            $data_label_value_update['vValue'] = $generalobj->getProperDataValueWithoutClean($vValue_uberx);
            $data_label_value_update['eAppType'] = $eAppType;
            $data_label_value_update['lPage_id'] = $lPage_id;
        ...
        if (!empty($vValue_deliverall)) {
            ...
            $data_label_value_update = array();
            $data_label_value_update['vValue'] = $generalobj->getProperDataValueWithoutClean($vValue_deliverall);
            $data_label_value_update['eAppType'] = $eAppType;
            $data_label_value_update['lPage_id'] = $lPage_id;
        ...
        if (!empty($vValue_food)) {
            ...
            $data_label_value_update = array();
            $data_label_value_update['vValue'] = $generalobj->getProperDataValueWithoutClean($vValue_food);
            $data_label_value_update['eAppType'] = $eAppType;
            $data_label_value_update['lPage_id'] = $lPage_id;
    ...
    if (!empty($vValue_cubejek)) {
        ...
        $data_label_value_update = array();
        $data_label_value_update['vValue'] = $generalobj->getProperDataValueWithoutClean($vValue_cubejek);
        $data_label_value_update['eAppType'] = $eAppType;
        $data_label_value_update['lPage_id'] = $lPage_id;
...
if (isset($_POST['submit']) == false && $action == "Edit") {
    ...
    if ($_SERVER['HTTP_HOST'] == "192.168.1.131" || $_SERVER['HTTP_HOST'] == "192.168.1.151") {
        ...
        $PASSWORD_OPPOSITE_HOST = "Admin@205";
        $obj_opposite = new DBConnection($OPPOSITE_HOST, 'cubejekdev', $USER_OPPOSITE_HOST, $PASSWORD_OPPOSITE_HOST);
        //echo "<pre>";print_r($obj_opposite);die;
    } else if ($_SERVER['HTTP_HOST'] == "192.168.1.141") {
        $OPPOSITE_HOST = "192.168.1.131";
        $USER_OPPOSITE_HOST = "root";
        $PASSWORD_OPPOSITE_HOST = "root";
