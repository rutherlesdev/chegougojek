<?php
	...
	if(isset($_POST['submit'])) { //form submit
	   ...
	   if($action == "Edit" && !$userObj->hasPermission('edit-banner')){
		...
		if(!empty($id) && SITE_TYPE =='Demo'){
			$_SESSION['success'] = 2;
			header("Location:store_banner.php");exit;
		}
	...
	if($action == 'Edit') {
		...
		$sql = "SELECT vTitle,eStatus,vImage,iDisplayOrder,iServiceId FROM ".$tbl_name." WHERE iUniqueId = '".$id."'";
							...
							<form method="post" action="" enctype="multipart/form-data">
								...
								<div class="row">
									...
									<div class="col-lg-6">
										<?
											...
											$query1 = "SELECT DISTINCT iDisplayOrder FROM ".$tbl_name." WHERE vCode = '".$default_lang."' ORDER BY iDisplayOrder";
								...
								<div class="row">
									<div class="col-lg-12">
										...
										<?php } ?>
                                                                                        <a href="store_banner.php" class="btn btn-default back_link">Cancel</a>
									</div>
								</div>
							</form>
						</div>
