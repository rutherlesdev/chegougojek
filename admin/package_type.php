...
if (!$userObj->hasPermission('view-package-type')) {
    $userObj->redirect();
}
$script = 'Package';
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td width="10%" class=" padding-right10"><select name="option" id="option" class="form-control">
                                            ...
                                            <option value="vName_<?= $default_lang ?>" <?php
                                    ...
                                    <?php if ($userObj->hasPermission('create-package-type')) { ?>
                                ...
                                <div class="admin-nir-export">
                                    <div class="changeStatus col-lg-12 option-box-left">
                                        <span class="col-lg-2 new-select001">
                                            <?php if ($userObj->hasPermission(['update-status-package-type', 'delete-package-type'])) { ?>
                                                <select name="changeStatus" id="changeStatus" class="form-control" onchange="ChangeStatusAll(this.value);">
                                                    <option value="" >Select Action</option>
                                                    <?php if ($userObj->hasPermission('update-status-package-type')) { ?>
                                                        ...
                                                        ?> >Deactivate</option>
                                                            <?php } ?>
                                                            <?php if ($userObj->hasPermission('delete-package-type')) { ?>
