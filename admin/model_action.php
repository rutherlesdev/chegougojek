<?
	...
	if(isset($_POST['submit'])) {
		...
		if($action == "Add" && !$userObj->hasPermission('create-vehicle-model')){
	        $_SESSION['success'] = 3;
	    ...
	    if($action == "Edit" && !$userObj->hasPermission('edit-vehicle-model')){
	        $_SESSION['success'] = 3;
					...
					<div class="body-div">
						<div class="form-group">
							...
							<form method="post" name="_model_form" id="_model_form" action="">
								...
								<div class="row">
									<div class="col-lg-12">
										<?php if(($action == 'Edit' && $userObj->hasPermission('edit-vehicle-model')) || ($action == 'Add' &&  $userObj->hasPermission('create-vehicle-model'))){ ?>
