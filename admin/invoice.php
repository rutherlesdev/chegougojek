...
//echo "<pre>";print_r($latitudes);die;
?>
<!DOCTYPE html>
                                    ...
                                    <div class="panel-body rider-invoice-new">
                                        <div class="row">
                                            <div class="col-sm-6 rider-invoice-new-left">
                                                ...
                                                if ($db_trip_data['eType'] == 'Ride') {
                                                    if (isset($strpOverPointData) && !empty($strpOverPointData)) {
                                                        foreach ($strpOverPointData as $strpOverPointDatakey => $strpOverPointDatavalue) {
                                                            ...
                                                            ?> 
                                                            <span class="location-to"><i class="icon-map-marker"></i> <b><?= @date('h:i A', @strtotime($strpOverPointDatavalue['tReachedTime'])); ?><p><?php
                                                                        if (!empty($strpOverPointDatavalue['tActualDAddress']))
                                                                            echo $strpOverPointDatavalue['tActualDAddress'];
                                                                        else
                                                                            echo $strpOverPointDatavalue['tDAddress'];
                                                                        ?></p></b></span>
                                                ...
                                                ?> 
                                                <?php if ($db_trip_data['eType'] != 'UberX' && empty($strpOverPointData)) { ?>
                                            ...
                                            <div class="col-sm-6 rider-invoice-new-right">
                                                ...
                                                <table style="width:100%" cellpadding="5" cellspacing="0" border="0">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $languageLabelsArr = $generalobj->getLanguageLabelsArrWeb($userlangcode, "1");
