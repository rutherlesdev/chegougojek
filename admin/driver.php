...
//$defaultcurename = $generalobjAdmin->get_default_currency();
$script = 'Driver';
...
if ($_POST['action'] == "Featured") {
    ...
    header("Location:" . $tconfig["tsite_url_main_admin"] . "driver.php");
    exit;
}
...
if ($keyword != '') {
    ...
    if ($option != '') {
        ...
        if ($eStatus != '') {
            ...
            if (SITE_TYPE == 'Demo') {
                $ssql .= " AND " . stripslashes($option_new) . " = '" . $generalobjAdmin->clean($keyword_new) . "' AND rd.eStatus = '" . $generalobjAdmin->clean($eStatus) . "'";
            }
        } else {
        ...
        if (ONLYDELIVERALL == 'Yes') {
            if ($eStatus != '') {
                ...
                if (SITE_TYPE == 'Demo') {
                    $ssql .= " AND (concat(rd.vName,' ',rd.vLastName) LIKE '%" . $generalobjAdmin->clean($keyword_new) . "%' OR rd.vEmail LIKE '%" . $generalobjAdmin->clean($keyword_new) . "%' OR (concat(rd.vCode,'',rd.vPhone) = '" . $generalobjAdmin->clean($keyword_new) . "')) AND rd.eStatus = '" . $generalobjAdmin->clean($eStatus) . "'";
                }
            } else {
                ...
                if (SITE_TYPE == 'Demo') {
                    $ssql .= " AND (concat(rd.vName,' ',rd.vLastName) LIKE '%" . $generalobjAdmin->clean($keyword_new) . "%' OR rd.vEmail LIKE '%" . $generalobjAdmin->clean($keyword_new) . "%' OR (concat(rd.vCode,'',rd.vPhone) = '" . $generalobjAdmin->clean($keyword_new) . "'))";
                }
            }
        } else {
            if ($eStatus != '') {
                ...
                if (SITE_TYPE == 'Demo') {
                    $ssql .= " AND (concat(rd.vName,' ',rd.vLastName) LIKE '%" . $generalobjAdmin->clean($keyword_new) . "%' OR c.vCompany LIKE '%" . $generalobjAdmin->clean($keyword_new) . "%' OR rd.vEmail LIKE '%" . $generalobjAdmin->clean($keyword_new) . "%' OR (concat(rd.vCode,'',rd.vPhone) = '" . $generalobjAdmin->clean($keyword_new) . "')) AND rd.eStatus = '" . $generalobjAdmin->clean($eStatus) . "'";
                }
            } else {
                ...
                if (SITE_TYPE == 'Demo') {
                    $ssql .= " AND (concat(rd.vName,' ',rd.vLastName) LIKE '%" . $generalobjAdmin->clean($keyword_new) . "%' OR c.vCompany LIKE '%" . $generalobjAdmin->clean($keyword_new) . "%' OR rd.vEmail LIKE '%" . $generalobjAdmin->clean($keyword_new) . "%' OR (concat(rd.vCode,'',rd.vPhone) = '" . $generalobjAdmin->clean($keyword_new) . "'))";
                }
            }
        }
    }
...
<html lang="en">
    ...
    <body class="padTop53">
            ...
            <div id="content">
                                ...
                                <tr>
                                    ...
                                    <td width="10%" class="padding-right10"><select name="option" id="option" class="form-control">
                                            ...
                                            ?> ><?php echo $langage_lbl_admin['LBL_DRIVER_TXT_ADMIN']; ?> Name</option>                                      
                                                ...
                                                ?> ><? if (isStoreDriverAvailable()>0) { ?>Company/Store<? } else { ?>Company <? } ?> Name</option>
                                                     <? } ?>
                                    ...
                                    <td width="30%">
                                        <?php if ($userObj->hasPermission('create-providers')) { ?>
                                            <a class="add-btn" href="driver_action.php" style="text-align: center;">Add <?= $langage_lbl_admin['LBL_DRIVER_TXT_ADMIN']; ?></a>
                                        <?php } ?>
                                    </td>
                                </tr>
                            </tbody>
                                ...
                                <div class="admin-nir-export">
                                    <div class="changeStatus col-lg-12 option-box-left">
                                        <span class="col-lg-2 new-select001">
                                            <?php if ($userObj->hasPermission(['update-status-providers', 'delete-providers'])) { ?>
                                        ...
                                        <table class="table table-striped table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th width="13%"><a href="javascript:void(0);" onClick="Redirect(1,<?php
                                                        ...
                                                        <th width="18%"><a href="javascript:void(0);" onClick="Redirect(2,<?php
                                                            if ($sortby == '2') {
                                                                ...
                                                                ?>0<?php } ?>)"><? if (isStoreDriverAvailable()>0) { ?>Company/Store<? } else { ?>Company <? } ?> Name <?php
                                                                               if ($sortby == 2) {
                                                                                   if ($order == 0) {
                                                                                       ?><i class="fa fa-sort-amount-asc" aria-hidden="true"></i> <?php } else { ?><i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php
                                                                    }
                                                    ...
                                                    <th width="12%" class="align-left"><a href="javascript:void(0);" onClick="Redirect(4,<?php
                                                        if ($sortby == '4') {
                                                            echo $order;
                                                        } else {
                                                    ...
                                                    <th width="8%" class="align-center">Action</th> </tr>
                                                        ...
                                                        <tr class="gradeA" >
                                                            ...
                                                            if ($APP_TYPE != "UberX") {
                                                                if ($data_drv[$i]['count'] != 0) {
                                                                    ?>
                                                                    <td align="center">
                                                                        <?php if ($userObj->hasPermission('view-provider-taxis')) { ?>
                                                                            <a href="vehicles.php?&actionSearch=1&iDriverId=<?= $data_drv[$i]['iDriverId']; ?>" target="_blank"><?php echo $data_drv[$i]['count']; ?></a>
                                                                            <?php
                                                                        } else {
                                                            ...
                                                            <td>
                                                                ...
                                                                if ($data_drv[$i]['eStatus'] != "Deleted") {
                                                                    echo $generalobj->formateNumAsPerCurrency($user_available_balance, '');
                                                                    ?>
                                                            ...
                                                            <?php if ($doc_count != 0) { ?>
                                                                <?php //if($userObj->hasPermission('edit-document')){      ?>
                                                                <td align="center">
                                                                    <?php $newUrl2 = "driver_document_action.php?id=" . $data_drv[$i]['iDriverId'] . "&action=edit&user_type=driver"; ?>
                                                                    <a href="<?= $newUrl2; ?>" data-toggle="tooltip" title="Edit <?= $langage_lbl_admin['LBL_DRIVER_TXT_ADMIN']; ?> Document" target="_blank" class="adminProviderDocumentClass">
                                                                    ...
                                                                    <?php if ($userObj->hasPermission('manage-provider-services')) { ?>
                                                                        <td align="center">
                                                                            <?php if ($hideUfxColumn > 0) { ?>
                                                                                <?php $newUrl2 = "manage_service_type.php?iDriverId=" . $data_drv[$i]['iDriverId'] . ""; ?>
                ...
                <?php if ($hideUfxColumn > 0) { ?>
                                                                            <form name="frmfeatured" id="frmfeatured" action="" method="post">
                                                                                ...
                                                                                <input type="hidden" name="eIsFeatured" value="<?= ($data_drv[$i]['eIsFeatured'] == "Yes") ? 'No' : 'Yes' ?>" >
        ...
        <?php //if($userObj->hasPermission('edit-providers')){        ?>
            ...
            <?php if ($userObj->hasPermission('update-status-providers')) { ?>
                                                                                    <li class="entypo-facebook" data-network="facebook"><a href="javascript:void(0);" onClick="changeStatus('<?php echo $data_drv[$i]['iDriverId']; ?>', 'Inactive')"  data-toggle="tooltip" title="Activate">
                                                                                            <img src="img/active-icon.png" alt="<?php echo $data_drv[$i]['eStatus']; ?>" >
                                                                                        </a></li>
                                                                                    <li class="entypo-gplus" data-network="gplus"><a href="javascript:void(0);" onClick="changeStatus('<?php echo $data_drv[$i]['iDriverId']; ?>', 'Active')" data-toggle="tooltip" title="Deactivate">
            ...
            <?php if ($userObj->hasPermission('delete-providers') && $eStatus != 'Deleted') { ?>
                                                              ...
                                                              <!--   <li class="entypo-gplus" data-network="gplus"><a href="javascript:void(0);" onClick="resetTripStatus('<?php echo $data_drv[$i]['iDriverId']; ?>')"  data-toggle="tooltip" title="Reset"><img src="img/reset-icon.png" alt="Reset"></a></li> -->
                                                                                <?php //}     ?>
