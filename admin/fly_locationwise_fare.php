...
<html lang="en">
    ...
    <head>
        <meta charset="UTF-8" />
       <title><?=$SITE_NAME?> | <?=$langage_lbl_admin['LBL_FLY_LOCATION_WISE_FARE']?></title>
            ...
            <div id="content">
                <div class="inner">
                    <div id="add-hide-show-div">
                        <div class="row">
                            <div class="col-lg-12">
                                <h2><?=$langage_lbl_admin['LBL_FLY_LOCATION_WISE_FARE']?></h2>
                              ...
                              <tbody>
                                <tr>
                                    ...
                                    <?php if($userObj->hasPermission('create-fly-fare')){ ?>
                                      <td width="20%"><a class="add-btn" href="fly_location_wise_fare_action.php" style="text-align: center;">Add <?=$langage_lbl_admin['LBL_FLY_LOCATION_WISE_FARE']?></a></td>
                                    <?php } ?>
                                </tr>
                              </tbody>
                        </table>
...
<!--                                    <div class="panel-heading">
                                                        ...
                                                        <td align="center" style="text-align:center;" class="action-btn001">
                                                            <div class="share-button openHoverAction-class" style="display: block;">
                                                                ...
                                                                <div class="social show-moreOptions openPops_<?= $data_drv[$i]['iLocatioId']; ?>">
                                                                    <ul>
                                                                        <li class="entypo-twitter" data-network="twitter"><a href="fly_location_wise_fare_action.php?id=<?= $data_drv[$i]['iLocatioId']; ?>" data-toggle="tooltip" title="Edit">
                    ...
                    <div class="admin-notes">
                            ...
                            <ul>
                                    <li>
                                            <?=$langage_lbl_admin['LBL_FLY_LOCATION_WISE_FARE']?> module will list all locations for flat fare on this page.
                                    </li>
                                    <li>
