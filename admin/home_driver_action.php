<?
	...
	if(isset($_POST['submit'])) { //form submit
		...
		if($action == "Add" && !$userObj->hasPermission('create-our-provider')){
	        $_SESSION['success'] = 3;
	        $_SESSION['var_msg'] = 'You do not have permission to create App screenshot.';
	        header("Location:home_driver.php");
	        exit;
	    }

	    if($action == "Edit" && !$userObj->hasPermission('edit-our-provider')){
	        $_SESSION['success'] = 3;
	        $_SESSION['var_msg'] = 'You do not have permission to update App screenshot.';
	        header("Location:home_driver.php");
	        exit;
	    }
...
<!-- 								<div class="row">
								...
								if($count_all > 0) {
									...
									<div class="col-lg-12">
										<?php if(($action == 'Edit' && $userObj->hasPermission('edit-our-provider')) || ($action == 'Add' &&  $userObj->hasPermission('create-our-provider'))){ ?>
