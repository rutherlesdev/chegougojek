...
if ($keyword != '') {
    if ($option != '') {
        ...
        if ($eStatus != '') {
             $ssql .= " AND vPageName LIKE '%" . $keyword . "%' OR vPageTitle_" . $default_lang . " LIKE '%" . $keyword . "%' AND eStatus = '" . $generalobjAdmin->clean($eStatus) . "' ";
        } else {
...
if(strtoupper(DELIVERALL) == "YES") {
    if (count($serviceIdArray) == 1 && ($serviceIdArray[0]!=1 && $serviceIdArray[0]!=2)) {
        ...
        $safety_practice_sql = "";
        if (count($serviceIdArray) == 1) $note_shown_safety = 0;
        else $note_shown_safety = 1;
    }
}
                                        ...
                                        <table class="table table-striped table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th width="5%" align="center" style="text-align:center;"><!--<a href="javascript:void(0);" onClick="Redirect(4,<?php
                                                if ($sortby == '4') {
                                                    echo $order;
                                                } else {
                                            ...
                                            <tbody>
                                                        ...
                                                        if (!empty($data_drv)) {
                                                            for ($i = 0; $i < count($data_drv); $i++) {
                                                                ...
                                                                if ($cubexthemeon == 'No' && ($data_drv[$i]['iPageId'] == '48' || $data_drv[$i]['iPageId'] == '49' || $data_drv[$i]['iPageId'] == '50' || $data_drv[$i]['iPageId'] == '52'))
                                                                    continue;
                                                                if ($cubexthemeon == 'Yes' && ($data_drv[$i]['iPageId'] == 1))
                                                                    continue;
                                                            ...
                                                            <td align="center" style="text-align:center;" class="action-btn001">
                                                                <div class="share-button openHoverAction-class" style="display: block;">
                                                                    ...
                                                                    <div class="social show-moreOptions for-five openPops_<?= $data_drv[$i]['iPageId']; ?>">
                                                                        <ul>
                                                                            <li class="entypo-twitter" data-network="twitter"><a href="page_action.php?id=<?= $data_drv[$i]['iPageId']; ?>" data-toggle="tooltip" title="Edit">
                                                                                    <img src="img/edit-icon.png" alt="Edit">
                                                                                </a></li>
                                                        <?php if ($data_drv[$i]['iPageId'] != 22 && $data_drv[$i]['iPageId'] != 31 && $data_drv[$i]['iPageId'] != 46) { ?>
                                                                                <li class="entypo-facebook" data-network="facebook"><a href="javascript:void(0);" onClick="changeStatus('<?php echo $data_drv[$i]['iPageId']; ?>', 'Inactive')"  data-toggle="tooltip" title="Activate">
                                                                                        <img src="img/active-icon.png" alt="<?php echo $data_drv[$i]['eStatus']; ?>" >
                                                                                    </a></li>
                                                                                <li class="entypo-gplus" data-network="gplus"><a href="javascript:void(0);" onClick="changeStatus('<?php echo $data_drv[$i]['iPageId']; ?>', 'Active')" data-toggle="tooltip" title="Deactivate">
