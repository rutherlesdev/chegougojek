...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
	...
	<head>
		...
		<script type="text/javascript">
			...
			{
				var confirm_ans = confirm("Are You sure You want to Delete Hotel Banner?");
				return confirm_ans;
												...
												<thead>
													<tr>
														...
														<?php if($userObj->hasPermission('update-status-banner')){ ?>
															<th>Status</th>
														<?php } ?>
														<?php if($userObj->hasPermission('edit-banner')){ ?>
															<th>Edit</th>
														<?php } ?>
...
<tr class="gradeA">
	<td width="10%" align="center">
		...
		<img src="<?=$tconfig["tsite_url"].'resizeImg.php?w=100&h=100&src='.$tconfig['tsite_upload_images_hotel_banner'] . '/' . $vImage ?>" height="50" width="50">
 ...
 ?>
																...
																<td width="10%" align="center">
																	<?if ($iDisplayOrder != 1) {?>
																		<a href="hotel_banner.php?id=<?=$iUniqueId;?>&flag=up">
																			<button class="btn btn-warning">
																				<i class="icon-arrow-up"></i>
																			</button>
																		</a>
																		<?}if ($iDisplayOrder != $count_all) {?>
																		<a href="hotel_banner.php?id=<?=$iUniqueId;?>&flag=down">
																			<button class="btn btn-warning">
