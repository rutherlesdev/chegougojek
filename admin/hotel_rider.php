            ...
            <div id="content">
                <div class="inner">
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="admin-nir-table">
                              <tbody>
                                <tr>
                                    ...
                                    <td width="30%"><a class="add-btn" href="hotel_rider_action.php" style="text-align: center;">Add Kiosk Admin</a></td>
                                </tr>
                              </tbody>
                        </table>
                                                ...
                                                <tbody>
													<?php if(!empty($data_drv)) { 
														...
														<td align="center" style="text-align:center;"><input type="checkbox" id="checkbox" name="checkbox[]" <?php echo $default; ?> value="<?php echo $data_drv[$i]['iHotelId']; ?>" />&nbsp;</td>
															...
															<td data-order="<?=$data_drv[$i]['iHotelId']; ?>"><? echo $generalobjAdmin->DateTime($data_drv[$i]['tRegistrationDate']) ?></td>
                    ...
                    <div class="admin-notes">
                            ...
                            <ul>
                                    <li>
                                            Kiosk Admin module will list all Kiosk Holders/Admin on this page.
                                    </li>
                                    <li>
                                            Super Administrator can Activate / Deactivate / Delete any Kiosk Admin.
                                    </li>
                                    <li>
                                            Super Administrator can export data in XLS or PDF format.
                                    </li>
                                    <!--li>
