...
if (!empty($img_arr)) {
    foreach ($img_arr as $key => $value) {
        if (!empty($value['name'])) { 
            ...
            else if($key=='kiosk_section_img') $key = 'lKioskSection';
            ...
            else if($key=='service_section_img_first' || $key=='service_section_img_sec' || $key=='service_section_img_third' || $key=='service_section_img_fourth' || $key=='service_section_img_fifth' || $key=='service_section_img_six') $key = 'lServiceSection';
            ...
            for ($i=1; $i <= 6; $i++) {
                if($key=='how_it_work_section_hiw_img'.$i) {
                    ...
                    $img_str = 'hiw_img'.$i.'_';
                }else if($key=='cartype_section_block_img'.$i){
                    $key = 'lCartypeSection';
                    $img_str = 'cartype_img'.$i.'_';
                }
            }
...
if(isset($_POST['submit'])) {
      ...
      $check_file_query = "SELECT lBannerSection,lHowitworkSection,lSecuresafeSection,lDownloadappSection,lCalltobookSection,lEarnSection,lCalculateSection,lCartypeSection,lServiceSection,lBenefitSection,lKioskSection FROM $tbl_name where eFor='" . $eFor . "'";
      $check_file = $obj->MySQLSelect($check_file_query);
      ...
      $sectionData = json_decode($check_file[0]['lKioskSection'],true);
      $kiosk_section_arr['menu_title_'.$vCode] = isset($_POST['kiosk_section_menu_title']) ? $_POST['kiosk_section_menu_title'] : '';
      $kiosk_section_arr['title_'.$vCode] = isset($_POST['kiosk_section_title']) ? $_POST['kiosk_section_title'] : '';
      $kiosk_section_arr['desc_'.$vCode] = isset($_POST['kiosk_section_desc']) ? $_POST['kiosk_section_desc'] : '';
      $kiosk_section_arr['img_'.$vCode] = isset($sectionData['img_'.$vCode]) ? $sectionData['img_'.$vCode] : '';
      $kiosk_section_arr = !(empty($sectionData)) ? array_merge($sectionData,$kiosk_section_arr) : $kiosk_section_arr;
      $kiosk_section = $generalobj->getJsonFromAnArr($kiosk_section_arr);
      ...
      $cartype_section_arr['title_'.$vCode] = isset($_POST['cartype_section_title']) ? $_POST['cartype_section_title'] : '';
      $cartype_section_arr['desc_'.$vCode] = isset($_POST['cartype_section_desc']) ? $_POST['cartype_section_desc'] : '';
      $cartype_section_arr['img_'.$vCode] = isset($sectionData['img_'.$vCode]) ? $sectionData['img_'.$vCode] : '';
      $cartype_section_arr = !(empty($sectionData)) ? array_merge($sectionData,$cartype_section_arr) : $cartype_section_arr;

        /* For Our cartype Section Added By PJ 25 Sep 2019 */
            for ($i=1; $i <= 6; $i++) {
            $cartype_section_arr['cartype_title'.$i.'_'.$vCode] = isset($_POST['cartype_section_block_title'.$i]) ? $_POST['cartype_section_block_title'.$i] : '';
        }
        /* ---------------------------------------- */
      ...
      $service_section_arr['title_fourth_'.$vCode] = isset($_POST['service_section_title_fourth']) ? $_POST['service_section_title_fourth'] : '';
      $service_section_arr['desc_fourth_'.$vCode] = isset($_POST['service_section_desc_fourth']) ? $_POST['service_section_desc_fourth'] : '';
      $service_section_arr['title_fifth_'.$vCode] = isset($_POST['service_section_title_fifth']) ? $_POST['service_section_title_fifth'] : '';
      $service_section_arr['desc_fifth_'.$vCode] = isset($_POST['service_section_desc_fifth']) ? $_POST['service_section_desc_fifth'] : '';
      $service_section_arr['title_six_'.$vCode] = isset($_POST['service_section_title_six']) ? $_POST['service_section_title_six'] : '';
      $service_section_arr['desc_six_'.$vCode] = isset($_POST['service_section_desc_six']) ? $_POST['service_section_desc_six'] : '';
      ...
      $service_section_arr['img_third_'.$vCode] = isset($sectionData['img_third_'.$vCode]) ? $sectionData['img_third_'.$vCode] : '';
      $service_section_arr['img_fourth_'.$vCode] = isset($sectionData['img_fourth_'.$vCode]) ? $sectionData['img_fourth_'.$vCode] : '';
      $service_section_arr['img_fifth_'.$vCode] = isset($sectionData['img_fifth_'.$vCode]) ? $sectionData['img_fifth_'.$vCode] : '';
      $service_section_arr['img_six_'.$vCode] = isset($sectionData['img_six_'.$vCode]) ? $sectionData['img_six_'.$vCode] : '';
...
if (isset($_POST['submit'])) {
    if (SITE_TYPE == 'Demo') {
        header("Location:home_content_taxi.php?id=" . $id . "&success=2");
        exit;
    }
    //$q = "INSERT INTO ";
    //$where = '';
...
if ($action == 'Edit') {
    ...
    if (count($db_data) > 0) { 
        foreach ($db_data as $key => $value) {
            ...
            $kiosk_section = json_decode($value['lKioskSection'],true);
...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <head>
        <meta charset="UTF-8" />
        <title>Admin | Taxi Home Content <?= $action; ?></title>
        ...
        <div id="wrap">
            ...
            <div id="content">
                <div class="inner">
                    <div class="row">
                        <div class="col-lg-12">
                            <h2><?= $action; ?> Taxi Home Content (<?php echo $title; ?>)</h2>
                            <? if($generalobj->checkCubeJekXThemOn()=='Yes') { ?>
                            <a href="home_content_cubejekx_action.php?id=<?= $id ?>">
                            <? } else { ?>
                            <a href="home_content_taxi.php" class="back_link">
                                <? } ?>
                    ...
                    <div class="body-div">
                        <div class="form-group">
                            ...
                            <form method="post" name="_home_content_form" id="_home_content_form" action="" enctype='multipart/form-data'>
                                ...
                                <input type="hidden" name="backlink" id="backlink" value="home_content_taxi.php"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <br/>
                                                <span class="notes">[Note: For Better Resolution Upload only image size of 855px * 285px.]</span>
                                            </div>
                                        </div>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <? if ($how_it_work_section['hiw_img'.$i.'_'.$vCode] != '') { ?>
                                                               <!--  <img src="<?= $tconfig["tsite_upload_apptype_page_images"].$template.'/'.$how_it_work_section['hiw_img'.$i.'_'.$vCode]; ?>" class="innerbg_image"/ style="max-height:100px;"> -->
                                                                ...
                                                                <img src="<?= $tconfig["tsite_url"].'resizeImg.php?h=200&src='.$tconfig["tsite_upload_apptype_page_images"].$template.'/'.$how_it_work_section['hiw_img'.$i.'_'.$vCode]; ?>" class="innerbg_image"/ style="max-height:100px;">
                                 ...
                                 <div class="body-div innersection">
                                    <div class="form-group">
                                       ...
                                       <div class="row">
                                           ...
                                           <div class="col-lg-6">
                                               <textarea class="form-control" rows="5" name="service_section_main_desc"  placeholder="Main Description"><?= $service_section['main_desc_'.$vCode]; ?></textarea>
                                           </div>
                                       </div>
                                       ...
                                       <div class="row">
                                           ...
                                           <div class="col-lg-6">
                                                <textarea class="form-control" rows="5" name="service_section_desc_third" placeholder="Description"><?= $service_section['desc_third_'.$vCode]; ?></textarea>
                                           </div>
                                       </div>
                                       <div class="row">
                                           <div class="col-lg-12">
                                       ...
                                       <div class="row">
                                           ...
                                           <div class="col-lg-6">
                                               <input type="text" class="form-control" name="service_section_title_fourth" value="<?= $service_section['title_fourth_'.$vCode]; ?>" placeholder="Title">
                                           </div>
                                       </div>
                                       ...
                                       <div class="row">
                                           ...
                                           <div class="col-lg-6">
                                                <textarea class="form-control" rows="5" name="service_section_desc_fourth" placeholder="Description"><?= $service_section['desc_fourth_'.$vCode]; ?></textarea>
                                           </div>
                                       </div>
                                       <div class="row">
                                           <div class="col-lg-12">
                                           ...
                                           <div class="col-lg-6">
                                                <? if ($service_section['img_fourth_'.$vCode] != '') { ?>
                                                  <!--  <img src="<?= $tconfig["tsite_upload_apptype_page_images"].$template.'/'.$service_section['img_fourth_'.$vCode]; ?>" class="innerbg_image"/> -->
                                                   <img src="<?= $tconfig["tsite_url"].'resizeImg.php?h=300&src='.$tconfig["tsite_upload_apptype_page_images"].$template.'/'.$service_section['img_fourth_'.$vCode]; ?>" class="innerbg_image"/>
                                                <? } ?>
                                               <input type="file" class="form-control" name="service_section_img_fourth" value="<?= $service_section['img_fourth_'.$vCode]; ?>">
                                               <span class="notes">[Note: For Better Resolution Upload only image size of 78px * 78px.]</span>
                                           </div>
                                       </div>
                                       ...
                                       <div class="row">
                                           ...
                                           <div class="col-lg-6">
                                               <input type="text" class="form-control" name="service_section_title_fifth" value="<?= $service_section['title_fifth_'.$vCode]; ?>" placeholder="Title">
                                           </div>
                                       </div>
                                       ...
                                       <div class="row">
                                           ...
                                           <div class="col-lg-6">
                                                <textarea class="form-control" rows="5" name="service_section_desc_fifth" placeholder="Description"><?= $service_section['desc_fifth_'.$vCode]; ?></textarea>
                                           </div>
                                       </div>
                                       <div class="row">
                                           <div class="col-lg-12">
                                           ...
                                           <div class="col-lg-6">
                                                <? if ($service_section['img_fifth_'.$vCode] != '') { ?>
                                                 <!--   <img src="<?= $tconfig["tsite_upload_apptype_page_images"].$template.'/'.$service_section['img_fifth_'.$vCode]; ?>" class="innerbg_image"/> -->
                                                   <img src="<?= $tconfig["tsite_url"].'resizeImg.php?h=300&src='.$tconfig["tsite_upload_apptype_page_images"].$template.'/'.$service_section['img_fifth_'.$vCode]; ?>" class="innerbg_image"/>

                                                <? } ?>
                                               <input type="file" class="form-control" name="service_section_img_fifth" value="<?= $service_section['img_fifth_'.$vCode]; ?>">
                                               <span class="notes">[Note: For Better Resolution Upload only image size of 78px * 78px.]</span>
                                           </div>
                                       </div>
                                       ...
                                       <div class="row">
                                           ...
                                           <div class="col-lg-6">
                                               <input type="text" class="form-control" name="service_section_title_six" value="<?= $service_section['title_six_'.$vCode]; ?>" placeholder="Title">
                                           </div>
                                       </div>
                                       ...
                                       <div class="row">
                                           ...
                                           <div class="col-lg-6">
                                                <textarea class="form-control" rows="5" name="service_section_desc_six" placeholder="Description"><?= $service_section['desc_six_'.$vCode]; ?></textarea>
                                           </div>
                                       </div>
                                       <div class="row">
                                           <div class="col-lg-12">
                                           ...
                                           <div class="col-lg-6">
                                                <? if ($service_section['img_six_'.$vCode] != '') { ?>
                                                  <!--  <img src="<?= $tconfig["tsite_upload_apptype_page_images"].$template.'/'.$service_section['img_six_'.$vCode]; ?>" class="innerbg_image"/> -->

                                                   <img src="<?= $tconfig["tsite_url"].'resizeImg.php?h=300&src='.$tconfig["tsite_upload_apptype_page_images"].$template.'/'.$service_section['img_six_'.$vCode]; ?>" class="innerbg_image"/>


                                                <? } ?>
                                               <input type="file" class="form-control" name="service_section_img_six" value="<?= $service_section['img_six_'.$vCode]; ?>">
                                               <span class="notes">[Note: For Better Resolution Upload only image size of 78px * 78px.]</span>
                                           </div>
                                       </div>
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="row">
                                           ...
                                           <div class="col-lg-6">
                                               ...
                                               <span class="notes">[Note: For Better Resolution Upload only image size of 270px * 515px.]</span>
                                           </div>
                                       </div>
                                 ...
                                 <div class="body-div innersection">
                                    <div class="form-group">
                                       <div class="row"><div class="col-lg-12"><h3>Kiosk Section</h3></div></div>
                                       <div class="row">
                                           <div class="col-lg-12">
                                               <label>Menu Title</label>
                                           </div>
                                           <div class="col-lg-6">
                                               <input type="text" class="form-control" name="kiosk_section_menu_title"  id="kiosk_section_menu_title" value="<?= $kiosk_section['menu_title_'.$vCode]; ?>" placeholder="Menu Title">
                                           </div>
                                       </div>
                                       <div class="row">
                                           <div class="col-lg-12">
                                           ...
                                           <div class="col-lg-6">
                                               <input type="text" class="form-control" name="kiosk_section_title"  id="kiosk_section_title" value="<?= $kiosk_section['title_'.$vCode]; ?>" placeholder="Title" required>
                                           </div>
                                       </div>
                                       <div class="row">
                                           <div class="col-lg-12">
                                           ...
                                           <div class="col-lg-12">
                                               <textarea class="form-control ckeditor" rows="10" name="kiosk_section_desc"  id="kiosk_section_desc"  placeholder="Description"><?= $kiosk_section['desc_'.$vCode]; ?></textarea>
                                           </div>
                                       </div>
                                       <div class="row">
                                           <div class="col-lg-12">
                                           ...
                                           <div class="col-lg-6">
                                               <? if ($kiosk_section['img_'.$vCode] != '') { ?>
                                                   <!-- <img src="<?= $tconfig["tsite_upload_apptype_page_images"] . $template . "/" . $kiosk_section['img_'.$vCode]; ?>" class="innerbg_image"/> -->
                                                   <img src="<?= $tconfig["tsite_url"].'resizeImg.php?h=300&src='.$tconfig["tsite_upload_apptype_page_images"] . $template . "/" . $kiosk_section['img_'.$vCode]; ?>" class="innerbg_image"/>

                                               <? } ?>
                                               <input type="file" class="form-control FilUploader" name="kiosk_section_img"  id="kiosk_section_img" accept=".png,.jpg,.jpeg,.gif,.svg">
                                               <br/>
                                           </div>
                                       </div>
                                    </div>
                                 ...
                                 <div class="body-div innersection">
                                    <div class="form-group">
                                       <div class="row"><div class="col-lg-12"><h3>Car Type Section</h3></div></div>
                                       <div class="row">
                                           <div class="col-lg-12">
                                               <label>Menu Title</label>
                                           </div>
                                       ...
                                       <div class="row">
                                           ...
                                           <div class="col-lg-6">
                                               <input type="text" class="form-control" name="cartype_section_title"  id="cartype_section_title" value="<?= $cartype_section['title_'.$vCode]; ?>" placeholder="Title" required>
                                           </div>
                                       </div>
                                       <div class="row">
                                           <div class="col-lg-12">
                                           ...
                                           <div class="col-lg-12">
                                               <textarea class="form-control ckeditor" rows="10" name="cartype_section_desc"  id="cartype_section_desc"  placeholder="Description"><?= $cartype_section['desc_'.$vCode]; ?></textarea>
                                           </div>
                                       </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <h3>Our cartype Section Blocks</h3>
                                            ...
                                            <?php for ($i=1; $i <= 6; $i++) { ?>
                                                <div class="col-lg-4">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <label>Cartype Title <?php echo $i ; ?></label>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" name="cartype_section_block_title<?php echo $i ; ?>"  id="cartype_section_block_title<?php echo $i ; ?>" value="<?= $cartype_section['cartype_title'.$i.'_'.$vCode]; ?>" placeholder="Title">
                                                        </div>
                                                    </div>

                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <label>Cartype Image <?php echo $i ; ?></label>
                                                        </div>                                                    
                                                        <div class="col-lg-6">
                                                            <? if ($cartype_section['cartype_img'.$i.'_'.$vCode] != '') { ?>
                                                                <!-- <img src="<?= $tconfig["tsite_upload_apptype_page_images"].$template.'/'.$cartype_section['cartype_img'.$i.'_'.$vCode]; ?>" class="innerbg_image"/ style="max-height:100px;"> -->

                                                                <img src="<?= $tconfig["tsite_url"].'resizeImg.php?h=100&src='.$tconfig["tsite_upload_apptype_page_images"].$template.'/'.$cartype_section['cartype_img'.$i.'_'.$vCode]; ?>" class="innerbg_image"/ style="max-height:100px;">

                                                            <? } ?>
                                                            <input type="file" class="form-control FilUploader" name="cartype_section_block_img<?php echo $i ; ?>"  id="cartype_section_block_img<?php echo $i ; ?>" accept=".png,.jpg,.jpeg,.gif,.svg">
                                                            <span class="notes">[Note: For Better Resolution Upload only image size of 260px * 205px.]</span>
                                                            <br/>
                                                        </div>
                                                    </div>                                                                                                      
                                                <hr/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <br/>
                                               <span class="notes">[Note: For Better Resolution Upload only image size of 205px * 580px.]</span>
                                            </div>
                                            <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="row">
                                           ...
                                           <div class="col-lg-6">
                                               ...
                                               <br/>
                                               <span class="notes">[Note: For Better Resolution Upload only image size of 745px * 500px.]</span>
                                           </div>
                                       </div>
                                    </div>
                                 </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <a href="home_content_taxi.php" class="btn btn-default back_link">Cancel</a>
                                    </div>
                                </div>
                            </form>
                        </div>
...
<?php } ?>
                ...
                if (referrer == "") {
                    referrer = "home_content_taxi.php";
                } else { //alert('hi');
