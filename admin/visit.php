                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td width="10%" class=" padding-right10"><select name="option" id="option" class="form-control">
                                            ...
                                            <option value="tDestLocationName" <?php if ($option == "tDestLocationName") {
    echo "selected";
} ?> >Destination Location Title</option>
                                            <option value="tDestAddress" <?php if ($option == "tDestAddress") {
    echo "selected";
...
<?php if ($userObj->hasPermission(['update-status-visit', 'delete-visit'])) { ?>
                                    ...
                                    <form class="_list_form" id="_list_form" method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
                                        <table class="table table-striped table-bordered table-hover">
                                            <thead>
                                                ...
                                                <?php if ($_SESSION['SessionUserType'] != 'hotel') { ?><th>Hotel Name</th><?php } ?>
                                                    <th width="20%"><a href="javascript:void(0);" onClick="Redirect(1,<?php if ($sortby == '1') {
                                                    echo $order;
                                                } else { ?>0<?php } ?>)">Destination location Title<?php if ($sortby == 1) {
                                            ...
                                            echo $order;
                                        } else { ?>0<?php } ?>)">Destination <?php if ($sortby == 2) {
                                            if ($order == 0) { ?><i class="fa fa-sort-amount-asc" aria-hidden="true"></i> <?php } else { ?><i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php }
                                        } else { ?><i class="fa fa-sort" aria-hidden="true"></i> <?php } ?></a></th>
...
if (!empty($data_drv)) {
    for ($i = 0; $i < count($data_drv); $i++) {
        ...
        $sql = "SELECT * FROM administrators WHERE iAdminId = '" . $data_drv[$i]['iHotelId'] . "'";
        ...
        <?php if ($_SESSION['SessionUserType'] != 'hotel') { ?><td><?php echo $generalobj->clearName(" " . $db_visithotel[0]['vFirstName'] . " " . $db_visithotel[0]['vLastName']); ?></td><?php } ?>
                                                            <td><?= $data_drv[$i]['tDestLocationName']; ?></td>
...
<?php include('pagination_n.php'); ?>
                    ...
                    <div class="admin-notes">
                        ...
                        <ul>
                            ...
                            <li>
                                <? if ($_SESSION['SessionUserType'] == 'hotel') { ?>Hotel<? } else { ?>Administrator<? } ?> can Activate / Deactivate / Delete any Visit Location. 
                            </li>
                            <li>
