...
if($keyword != ''){
    if($option != '') {
		...
		if($eStatus != ''){
            $ssql.= " AND (lm2.vLocationName LIKE '%".$keyword."%' OR vt.vVehicleType LIKE '%".$keyword."%') AND ls.eStatus = '".$generalobjAdmin->clean($eStatus)."'";
        }else {
    ...
    if($eStatus != ''){
            $ssql.= " AND vt.iVehicleTypeId = '" .($searchVehicleType) . "' AND ls.eStatus = '".$generalobjAdmin->clean($eStatus)."'";
        }else{
                              ...
                              <tbody>
                                <tr>
                                    ...
                                    <select name="option" id="option" class="form-control">
                                      ...
                                      <option value="lm2.vLocationName" <?php if ($option == "lm2.vLocationName") { echo "selected"; } ?> >Airport Location</option>
                                 ...
                                 <td width="15%" class="searchform"><input type="Text" id="keyword" name="keyword" value="<?php echo $keyword; ?>"  class="form-control" /></td>
                                    ...
                                    <td width="12%" class="estatus_options" id="eStatus_options" >
                                        <select class="form-control" name ="searchVehicleType" id="searchVehicleType" required="required">
                                           ...
                                           <?php 
												...
												?> 
										   <option value ="<?php echo $VehicleTypeId; ?>" <?php if ($VehicleTypeId == "$searchVehicleType") { ?>selected<? } ?>><?php echo $VehicleType; ?></option>
													<?php } ?>
										</select> 
									</td>
									<?php } ?>
									<td width="12%" class="estatus_otions" id="eStatus_otions" >
                                      ...
                                      <input type="button" value="Reset" class="btnalt button11" onClick="window.location.href='airport_surcharge.php'"/>
                                    </td>
                                    <?php if($userObj->hasPermission('create-airport-surcharge')){ ?>
                                      <td width="20%"><a class="add-btn" href="airport_surcharge_action.php" style="text-align: center;">Add Surcharge</a></td>
                                    <?php } ?>
                                </tr>
                              </tbody>
                        </table>
                                            ...
                                            <table class="table table-striped table-bordered table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="gradeA">
                                                        ...
                                                        <td><?= $data_drv[$i]['fpickupsurchargefare']; ?></td>
                                                        <td><?= $data_drv[$i]['fdropoffsurchargefare']; ?></td>
                                                            ...
                                                            <div class="share-button openHoverAction-class" style="display: block;">
                                                                ...
                                                                <div class="social show-moreOptions openPops_<?= $data_drv[$i]['iLocatioId']; ?>">
                                                                    <ul>
                                                                        ...
                                                                        <li class="entypo-twitter" data-network="twitter"><a href="airport_surcharge_action.php?id=<?= $data_drv[$i]['iLocatioId']; ?>" data-toggle="tooltip" title="Edit">
