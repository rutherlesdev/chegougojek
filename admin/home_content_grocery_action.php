...
if (isset($_POST['submit'])) {
    if (SITE_TYPE == 'Demo') {
        header("Location:home_content_grocery.php?id=" . $id . "&success=2");
        exit;
    }
    //$q = "INSERT INTO ";
    //$where = '';
                    ...
                    <div class="body-div">
                        <div class="form-group">
                            ...
                            <form method="post" name="_home_content_form" id="_home_content_form" action="" enctype='multipart/form-data'>
                                ...
                                <input type="hidden" name="backlink" id="backlink" value="home_content_grocery.php"/>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <a href="home_content_grocery.php" class="btn btn-default back_link">Cancel</a>
                                    </div>
                                </div>
                            </form>
                        </div>
...
<?php } ?>
                ...
                if (referrer == "") {
                    referrer = "home_content_grocery.php";
                } else { //alert('hi');
