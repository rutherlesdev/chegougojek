            ...
            <div id="content">
                <div class="inner">
                                            ...
                                            <?php if ($userObj->hasPermission(['update-status-faq', 'delete-faq'])) { ?>
                                                <select name="changeStatus" id="changeStatus" class="form-control" onchange="ChangeStatusAll(this.value);">
                                                    ...
                                                    <?php if ($userObj->hasPermission('update-status-faq')) { ?>
                                                        ...
                                                        ?> >Deactivate</option>
                                                            <?php } ?>
                                                            <?php if ($eStatus != 'Deleted' && $userObj->hasPermission('delete-faq')) { ?>
                                                                    ...
                                                                    <div class="social show-moreOptions openPops_<?= $data_drv[$i]['iFaqId']; ?>">
                                                                        <ul>
                                                                            ...
                                                                            <?php if ($data_drv[$i]['eDefault'] != 'Yes') { ?>
                                                                                <?php if ($userObj->hasPermission('update-status-faq')) { ?>
                                                                                    <li class="entypo-facebook" data-network="facebook"><a href="javascript:void(0);" onclick="changeStatus('<?php echo $data_drv[$i]['iFaqId']; ?>', 'Inactive')"  data-toggle="tooltip" title="Activate">
                                                                                            <img src="img/active-icon.png" alt="<?php echo $data_drv[$i]['eStatus']; ?>" >
                                                                                        </a></li>
                                                                                    <li class="entypo-gplus" data-network="gplus"><a href="javascript:void(0);" onclick="changeStatus('<?php echo $data_drv[$i]['iFaqId']; ?>', 'Active')" data-toggle="tooltip" title="Deactivate">
                    ...
                    <div class="admin-notes">
                        <h4>Notes:</h4>
                        <ul><li>FAQ module will list all faqs on this page.</li>
