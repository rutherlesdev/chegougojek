...
if (isset($_POST['submit'])) {
    ...
    if ($action == "Add" && !$userObj->hasPermission('create-state')) {
        $_SESSION['success'] = 3;
    ...
    if ($action == "Edit" && !$userObj->hasPermission('edit-state')) {
        $_SESSION['success'] = 3;
                    ...
                    <div class="body-div">
                        <div class="form-group">
                            ...
                            <form method="post" action="" name="_state_form" id="_state_form" >
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <?php if (($action == 'Edit' && $userObj->hasPermission('edit-state')) || ($action == 'Add' && $userObj->hasPermission('create-state'))) { ?>
