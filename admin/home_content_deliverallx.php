...
if($id != '' && $status != ''){
	...
	header("Location:homecontent.php?success=2");exit;
}
}
...
$sql = "SELECT COUNT(hc.id) AS Total FROM `".$tbl_name."` as hc WHERE 1=1 AND hc.eStatus = 'Active' $ssql $ord";
...
if ($page <= 0)
    $page = 1;
//Pagination End
$sql = "SELECT hc.*,lm.vTitle FROM ".$tbl_name." as hc LEFT JOIN language_master as lm on lm.vCode = hc.vCode WHERE 1 = 1 AND hc.eStatus = 'Active' $ssql $ord LIMIT $start, $per_page ";
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="gradeA">
											...
											<td align="center" style="text-align:center;" class="action-btn001">
												<a href="home_content_deliverallx_action.php?id=<?= $data_drv[$i]['id']; ?>" data-toggle="tooltip" title="Edit">
...
<!--END MAIN WRAPPER -->
<form name="pageForm" id="pageForm" action="action/homecontent.php" method="post" >
