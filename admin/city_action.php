...
if (isset($_POST['submit'])) {
    ...
    if ($action == "Add" && !$userObj->hasPermission('create-city')) {
        $_SESSION['success'] = 3;
    ...
    if ($action == "Edit" && !$userObj->hasPermission('edit-city')) {
        $_SESSION['success'] = 3;
                    ...
                    <div class="body-div">
                        <div class="form-group">
                            ...
                            <form method="post" name="_city_form" id="_city_form" action="">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <?php if (($action == 'Edit' && $userObj->hasPermission('edit-city')) || ($action == 'Add' && $userObj->hasPermission('create-city'))) { ?>
