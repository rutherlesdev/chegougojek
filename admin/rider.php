...
if ($keyword != '') {
    ...
    if ($option != '') {
        ...
        if ($eStatus != '') {
            ...
            if (SITE_TYPE == 'Demo') {
                $ssql .= " AND " . stripslashes($option_new) . " = '" . $generalobjAdmin->clean($keyword_new) . "' AND eStatus = '" . $generalobjAdmin->clean($eStatus) . "'";
            }
        } else {
        ...
        if ($eStatus != '') {
            ...
            if (SITE_TYPE == 'Demo') {
                $ssql .= " AND (concat(vName,' ',vLastName) LIKE '%" . $generalobjAdmin->clean($keyword_new) . "%' OR vEmail LIKE '%" . $generalobjAdmin->clean($keyword_new) . "%' OR (CONCAT(vPhoneCode,'',vPhone) = '" . $generalobjAdmin->clean($keyword_new) . "')) AND eStatus = '" . $generalobjAdmin->clean($eStatus) . "'";
            }
        } else {
            ...
            if (SITE_TYPE == 'Demo') {
                $ssql .= " AND (concat(vName,' ',vLastName) LIKE '%" . $generalobjAdmin->clean($keyword_new) . "%' OR vEmail LIKE '%" . $generalobjAdmin->clean($keyword_new) . "%' OR (CONCAT(vPhoneCode,'',vPhone) = '" . $generalobjAdmin->clean($keyword_new) . "'))";
            }
        }
    }
                ...
                <div class="inner">
                    ...
                    ?> >Name</option>
                                    ...
                                    <td>
                                        ...
                                        <td width="30%"><a class="add-btn" href="rider_action.php" style="text-align: center;">Add <?= $langage_lbl_admin['LBL_RIDER_NAME_TXT_ADMIN']; ?></a></td>
<?php } ?>
                                </tr>
                            </tbody>
                        </table>
    ...
    <?php } ?>
                                        ...
                                        <table class="table table-striped table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th width="22%"><a href="javascript:void(0);" onClick="Redirect(1,<?php
                                                            if ($sortby == '1') {
                                                                ...
                                                                ?>0<?php } ?>)"><?= $langage_lbl_admin['LBL_RIDER_NAME_TXT_ADMIN']; ?> Name <?php if ($sortby == 1) {
                                                                if ($order == 0) {
                                                ...
                                                if ($sortby == '2') {
                                                    ...
                                                    ?><i class="fa fa-sort" aria-hidden="true"></i> <?php } ?></a></th>
                                                    <th width="22%"><a href="javascript:void(0);" onClick="Redirect(3,<?php
                                                    if ($sortby == '3') {
                                                        echo $order;
                                                    } else {
        ...
        <?php if ($userObj->hasPermission('update-status-users')) { ?>
                                                                                ...
                                                                                <li class="entypo-facebook" data-network="facebook"><a href="javascript:void(0);" onClick="changeStatus('<?php echo $data_drv[$i]['iUserId']; ?>', 'Inactive')"  data-toggle="tooltip" title="Activate">
                                                                                        <img src="img/active-icon.png" alt="<?php echo $data_drv[$i]['eStatus']; ?>" >
                                                                                    </a></li>
                                                                                <li class="entypo-gplus" data-network="gplus"><a href="javascript:void(0);" onClick="changeStatus('<?php echo $data_drv[$i]['iUserId']; ?>', 'Active')" data-toggle="tooltip" title="Deactivate">
