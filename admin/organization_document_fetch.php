...
<div class="upload-content">
    ...
    <form class="form-horizontal" id="frm6" method="post" enctype="multipart/form-data" action="organization_document_action.php?id=<?php echo $id[1] ; ?>&master=<?php echo $id[0] ; ?> " name="frm6">
