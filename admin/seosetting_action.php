<?php 
	...
	if(isset($_POST['submit'])) {
		...
		if($action == "Add" && !$userObj->hasPermission('create-seo-setting')){
	        $_SESSION['success'] = 3;
	        $_SESSION['var_msg'] = 'You do not have permission to create SEO Setting.';
	        header("Location:company_action.php");
	        exit;
	   	}

	   	if($action == "Edit" && !$userObj->hasPermission('edit-seo-setting')){
	        $_SESSION['success'] = 3;
	        $_SESSION['var_msg'] = 'You do not have permission to update SEO Setting.';
	        header("Location:company_action.php");
	        exit;
	   	}
		...
		<div id="wrap">
          ...
          <?} ?>
							<form method="post" action=""  enctype="multipart/form-data" name="_seo_form" id="_seo_form">
								...
								<div class="row">
										<div class="col-lg-12">
											<?php if(($action == 'Edit' && $userObj->hasPermission('edit-seo-setting')) || ($action == 'Add' &&  $userObj->hasPermission('create-seo-setting'))){ ?>
