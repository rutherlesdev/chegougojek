...
if(!$userObj->hasPermission('manage-cancel-trips-invoice')){
  $userObj->redirect();
}
...
$ENABLE_TIP_MODULE = $generalobj->getConfigurations("configurations","ENABLE_TIP_MODULE");
	...
	$sql = "SELECT vt.*,vc.vCategory_".$default_lang." as vehcat from vehicle_type as vt LEFT JOIN ".$sql_vehicle_category_table_name." as vc ON vc.iVehicleCategoryId = vt.iVehicleCategoryId where iVehicleTypeId = '".$db_trip[0]['iVehicleTypeId']."'";
