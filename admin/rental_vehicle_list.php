...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <head>
        <meta charset="UTF-8" />
        <title><?= $SITE_NAME; ?> |<?php echo $langage_lbl_admin['LBL_VEHICLE_TYPE_RENTAL_TXT']; ?></title>
                                            ...
                                            <thead>
                                                <tr>
                                                   <!--  <th align="center" width="3%" style="text-align:center;"><input type="checkbox" id="setAllCheck" ></th> -->
                                                    ...
                                                    <th width="10%" style="text-align:center;">Rental Packages</th>
                                            ...
                                            <tbody>
                                                ...
                                                if (!empty($data_drv)) {
                                                    for ($i = 0; $i < count($data_drv); $i++) {
                                                        ...
                                                        ?>
                                                        <tr class="gradeA">
                                                                                                                                                        <!--  <td style="text-align:center;"><input type="checkbox" id="checkbox" name="checkbox[]" <?php echo $default; ?> value="<?php echo $data_drv[$i]['iVehicleTypeId']; ?>" />&nbsp;</td> -->
                                                            ...
                                                            <td style="text-align:center;">
                                                                <?php if ($userObj->hasPermission(['view-rental-packages', 'create-rental-packages'])) { ?>
                                                                    <a href="rental_package.php?id=<?php echo $data_drv[$i]['iVehicleTypeId']; ?>" class="add-btn-sub">Add/View (<?php echo $total_rental_package; ?>) </a> 
        <?php } ?>
                                                            </td>
...
<?php include('pagination_n.php'); ?>
                    ...
                    <div class="admin-notes">
                        ...
                        <ul>
                            <li>
                                Rental <?php echo $langage_lbl_admin['LBL_Vehicle']; ?> Type  module will list all Rental <?php echo $langage_lbl_admin['LBL_Vehicle']; ?> Types on this page.
                            </li>
                            <!-- <li>
                              Administrator can Edit / Delete any Rental <?php echo $langage_lbl_admin['LBL_Vehicle']; ?> type. 
                            </li> -->
                        </ul>
                    </div>
                </div>
