...
if (isset($_POST['import'])) {
    ...
    try {
        ...
        header("location:make_import.php");
        exit();
    }
    ...
    foreach ($sheetData as $key => $value) {
        ...
        $make_name  = trim($value['name']);
        $status = isset($value['status']) ? $value['status'] : "Active";

        try {

            $make = Models\Make::where(["vMake" => $make_name])->first();
    ...
    if (count($insert_data) > 0) {
        Models\Make::insert($insert_data);
    }
...
<html lang="en">
    ...
    <head>
        <meta charset="UTF-8" />
        <title><?=$SITE_NAME?> | Make Import</title>
        ...
        <div id="wrap">
            ...
            <div id="content">
                <div class="inner">
                    <div class="row">
                        <div class="col-lg-12">
                            <h2><?php echo $langage_lbl_admin['LBL_CAR_MAKE_ADMIN']; ?> Import</h2>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <p class="alert alert-warning"><a class="btn btn-sm btn-info" href="library/assets/make_sample.xlsx" download="<?php echo $langage_lbl_admin['LBL_CAR_MAKE_ADMIN']; ?>">Click here</a> &nbsp; to download sample excel file.</p>
                            <br>
                            <form accept="" method="post" enctype="multipart/form-data">
                                <!-- <input type="hidden" name="debug"> -->
                                <div class="form-group">
                                    <label >Upload <?php echo $langage_lbl_admin['LBL_CAR_MAKE_ADMIN']; ?> Excel File</label>
