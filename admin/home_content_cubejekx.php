...
if ($id != '' && $status != '') {
    if (SITE_TYPE != 'Demo') {
        ...
        header("Location:home_content_cubejekx.php?success=2");
        exit;
    }
}
                                                    ...
                                                    for ($i = 0; $i < count($data_drv); $i++) {
                                                        ...
                                                        <tr class="gradeA">
                                                            ...
                                                            <td align="center" style="text-align:center;" class="action-btn001">
                                                                <a href="home_content_cubejekx_action.php?id=<?= $data_drv[$i]['id']; ?>" data-toggle="tooltip" title="Edit">
...
<?php //include('pagination_n.php');    ?>
        ...
        <!--END MAIN WRAPPER -->
        <form name="pageForm" id="pageForm" action="action/home_content_cubejekx.php" method="post" >
