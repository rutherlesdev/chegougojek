...
// print_r($generalobj->getAppTypeWiseHomeTable());exit;
...
if ($id != '' && $status != '') {
    if (SITE_TYPE != 'Demo') {
        ...
        header("Location:home_content.php?success=2");
        exit;
    }
}
                              ...
                              <tbody>
                                <tr>
                                    ...
                                    <td width="10%" class=" padding-right10"><select name="option" id="option" class="form-control">
                                          ...
                                          <option value="hc.vCode" <?php if ($option == "vCode") {
    echo "selected";
                                ...
                                <div class="table-responsive">
                                    <form class="_list_form" id="_list_form" method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
                                        <table class="table table-striped table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    <th width="58%"><a href="javascript:void(0);" onClick="Redirect(1,<?php if ($sortby == '1') {
    echo $order;
} else { ?>0<?php } ?>)">Title<?php if ($sortby == 1) {
