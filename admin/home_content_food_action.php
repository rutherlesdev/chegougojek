        ...
        if (!empty($value['name'])) { 
            ...
            for ($i=1; $i <= 6; $i++) {
                if($key=='how_it_work_section_hiw_img'.$i) {
                    ...
                    $img_str = 'hiw_img'.$i.'_';
                }else if($key=='cuisines_section_block_img'.$i){
                    $key = 'lCartypeSection';
...
if(isset($_POST['submit'])) {
      ...
      $cartype_section_arr = !(empty($sectionData)) ? array_merge($sectionData,$cartype_section_arr) : $cartype_section_arr;
        ...
        for ($i=1; $i <= 6; $i++) {
            $cartype_section_arr['cuisines_title'.$i.'_'.$vCode] = isset($_POST['cuisines_section_block_title'.$i]) ? $_POST['cuisines_section_block_title'.$i] : '';
        }
        /* ---------------------------------------- */
...
if (isset($_POST['submit'])) {
    if (SITE_TYPE == 'Demo') {
        header("Location:home_content_food.php?id=" . $id . "&success=2");
        exit;
    }
    //$q = "INSERT INTO ";
    //$where = '';
...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <head>
        <meta charset="UTF-8" />
        <title>Admin | Food Home Content <?= $action; ?></title>
        ...
        <div id="wrap">
            ...
            <div id="content">
                <div class="inner">
                    <div class="row">
                        <div class="col-lg-12">
                            <h2><?= $action; ?> Food Home Content (<?php echo $title; ?>)</h2>
                            <? if($generalobj->checkCubeJekXThemOn()=='Yes') { ?>
                            <a href="home_content_cubejekx_action.php?id=<?= $id ?>">
                            <? } else { ?>
                            <a href="home_content_food.php" class="back_link">
                                <? } ?>
                    ...
                    <div class="body-div">
                        <div class="form-group">
                            ...
                            <form method="post" name="_home_content_form" id="_home_content_form" action="" enctype='multipart/form-data'>
                                ...
                                <input type="hidden" name="backlink" id="backlink" value="home_content_food.php"/>
                                            ...
                                            <?php for ($i=1; $i <= 6; $i++) { ?>
                                                <div class="col-lg-4">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" name="cuisines_section_block_title<?php echo $i ; ?>"  id="cuisines_section_block_title<?php echo $i ; ?>" value="<?= $cartype_section['cuisines_title'.$i.'_'.$vCode]; ?>" placeholder="Title">
                                                        </div>
                                                    </div>
                                 ...
                                 <div class="body-div innersection">
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" name="call_section_link"  id="call_section_link" value="<?= $call_section['link_'.$vCode]; ?>" placeholder="Link" required>
                                            </div>
                                        </div>                                        
                                    </div>
                                 </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <a href="home_content_food.php" class="btn btn-default back_link">Cancel</a>
                                    </div>
                                </div>
                            </form>
                        </div>
...
<?php } ?>
                ...
                if (referrer == "") {
                    referrer = "home_content_food.php";
                } else { //alert('hi');
