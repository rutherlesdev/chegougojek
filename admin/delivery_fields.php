...
/* get make */
	...
	$iDeliveryFieldId	 = isset($_GET['iDeliveryFieldId'])?$_GET['iDeliveryFieldId']:'';
	...
	if($hdn_del_id != ''){
       ...
       $obj->sql_query($query);
		...
		header("Location:delivery_package.php?success=2");exit;
	}
	}
...
<html lang="en">
    ...
    <head>
        <meta charset="UTF-8" />
       <title><?=$SITE_NAME?> | <?= $langage_lbl_admin['LBL_MULTI_DELIVERY_FORM'] ?></title>
            ...
            <div id="content">
                <div class="inner">
                    <div id="add-hide-show-div">
                        <div class="row">
                            <div class="col-lg-12">
                                <h2><?= $langage_lbl_admin['LBL_MULTI_DELIVERY_FORM'] ?></h2> 
                              ...
                              <tbody>
                                <tr>
                                    ...
                                    <td width="10%" class=" padding-right10"><select name="option" id="option" class="form-control">
                                          ...
                                          <option value="vFieldName" <?php if ($option == "vFieldName") { echo "selected"; } ?> >Delivery Package Type</option>
                                    ...
                                    <td width="12%">
                                      ...
                                      <input type="button" value="Reset" class="btnalt button11" onClick="window.location.href='delivery_package.php'"/>
                                    </td>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table class="table table-striped table-bordered table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="gradeA">
                                                        <td align="center" style="text-align:center;"><input type="checkbox" id="checkbox" name="checkbox[]" <?php echo $default; ?> value="<?php echo $data_drv[$i]['iDeliveryFieldId']; ?>" />&nbsp;</td>
                                                        <td><?= $data_drv[$i]['vFieldName']; ?></td>
                                                        <td><?= $data_drv[$i]['iOrder']; ?></td>
                                                        ...
                                                        <td align="center" style="text-align:center;">
                                                            ...
                                                            <td align="center" style="text-align:center;" class="action-btn001">
                                                                <div class="share-button openHoverAction-class" style="display: block;">
                                                                    ...
                                                                    <div class="social show-moreOptions openPops_<?= $data_drv[$i]['iDeliveryFieldId']; ?>">
                                                                        <ul>
                                                                            <li class="entypo-twitter" data-network="twitter"><a href="delivery_package_action.php?id=<?= $data_drv[$i]['iDeliveryFieldId']; ?>" data-toggle="tooltip" title="Edit">
...
<form name="pageForm" id="pageForm" action="action/delivery_package.php" method="post" >
