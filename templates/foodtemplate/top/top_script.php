...
<!-- GLOBAL STYLES -->
<!-- PAGE LEVEL STYLES -->
<link href="https://fonts.googleapis.com/css?family=Exo+2:100,300,400,500,600,700,800,900" rel="stylesheet">
...
<? if($SITE_VERSION != 'v5') { ?> 
	...
	<link rel="stylesheet" href="assets/css/foodtemplate/design_v5.css">
	<link rel="stylesheet" href="assets/css/foodtemplate/style_v5.css">  
	<link rel="stylesheet" href="assets/css/foodtemplate/style_v5_color.css">
	<link rel="stylesheet" type="text/css" href="assets/css/foodtemplate/home-new.css">
	<link rel="stylesheet" type="text/css" href="assets/css/foodtemplate/home-new-media.css">
    <? } else { ?> 
...
<link rel="stylesheet" href="assets/css/foodtemplate/media.css">
<?php if($lang_ltr == "yes") { ?>
	<link rel="stylesheet" href="assets/css/foodtemplate/style_rtl.css">
<?php } ?>
<!-- Font CSS-->
