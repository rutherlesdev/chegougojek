  ...
  <ul id="listMenu">
		...
		<?php
			...
			<li><a href="legal" class="<?=(isset($script) && $script == 'Legal')?'active':'';?>"><?=$langage_lbl['LBL_LEGAL']; ?></a></li>
              ...
              <li><a href="processing-orders" class="<?=(isset($script) && $script == 'ProcessingOrder')?'active':'';?>"><b><i aria-hidden="true" class="fa fa-dot-circle-o"></i></b><span><?=$langage_lbl['LBL_MY_PROCESSING_ORDERS_TXT'];?></span></a></li>
							...
							<li><a href="settings" class="<?=(isset($script) && $script == 'Settings')?'active':'';?>"><b><i aria-hidden="true" class="fa fa-gear"></i></b><span>Settings</span></a></li>
							<li class="logout"><a href="logout"><b><img alt="" src="assets/img/sign-out.png"></b><span><?=$langage_lbl['LBL_LOGOUT'];?></span></a></li>
    ...
    <span class="mobile">
        ...
        <?php
          ...
          <li><a href="driver-order" class="<?=(isset($script) && $script == 'Order')?'active':'';?>"><?=$langage_lbl['LBL_MY_ORDERS_TXT']; ?></a></li>
          ...
          ?>
              ...
              <li><a href="vehicle" class="<?=(isset($script) && $script == 'Vehicle')?'active':'';?>"><?=$langage_lbl['LBL_LEFT_MENU_VEHICLES']; ?></a></li>
              <li><a href="company-order" class="<?=(isset($script) && $script == 'Order')?'active':'';?>"><?=$langage_lbl['LBL_MY_ORDERS_TXT']; ?></a></li>
          <?php
              }
              else if($user == 'rider'){
          ?>
              <li><a href="profile-rider" class="<?=(isset($script) && $script == 'Profile')?'active':'';?>"><?=$langage_lbl['LBL_MY_PROFILE_HEADER_TXT']; ?></a></li>
              <li><a href="myorder" class="<?=(isset($script) && $script == 'Order')?'active':'';?>"><?=$langage_lbl['LBL_MY_ORDERS_TXT']; ?></a></li>
         <?php
              }
          ?>
          <!-- End Top Menu Mobile -->
