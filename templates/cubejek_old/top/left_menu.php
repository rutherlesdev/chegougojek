            ...
            <div class="menu-left-new">
                ...
                <?php if ($user == "") { ?>
                    ...
                    if ($user == 'driver') {
                        ...
                        if ($APP_TYPE == 'UberX' || $APP_TYPE == 'Ride-Delivery-UberX') {
                            ...
                            if ($WALLET_ENABLE == 'Yes') {
                                ?> 
                                <li><a href="driver_wallet" class="<?= (isset($script) && $script == 'Rider Wallet') ? 'active' : ''; ?>"><b><img alt="" src="assets/img/image_icon2.svg"></b><span><?= $langage_lbl['LBL_RIDER_WALLET']; ?></span></a></li>
                                <?
                            }
                        }
                ...
                <?php if ($user == "") { ?>
                    ...
                    <b>
                        ...
                        <? if (DELIVERALL == 'Yes') { ?>
                            <a class="<?= (isset($script) && $script == 'Store Sign-Up') ? 'active' : ''; ?>" href="sign-up-restaurant"><?= $langage_lbl['LBL_LEFTMENU_BECOME_A_STORE']; ?></a>

                            <?
                        }
                        if (($APP_TYPE == 'Ride-Delivery-UberX' || $APP_TYPE == 'Ride-Delivery' || $APP_TYPE == 'Ride') && $ENABLE_CORPORATE_PROFILE == "Yes" && ONLYDELIVERALL == "No") {
                            ?>
