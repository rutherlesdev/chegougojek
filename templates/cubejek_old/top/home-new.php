        ...
        <div class="phone-part"> 
          <span>
            <?php  if(!empty($SUPPORT_PHONE)){ ?>
              <b><img src="assets/img/home-new/phone.png" alt="" /> <?php echo $SUPPORT_PHONE ?></b>
            <?php } ?>
            <?php  if(!empty($SUPPORT_MAIL)){ ?>
              <b><img src="assets/img/home-new/mgs.png" alt="" /><a href="#">
              <?php echo $SUPPORT_MAIL ?> </a></b>
            <?php } ?>
          </span>
        </div>
        <div class="lang-part">
...
<div class="download-app-today">
  <div class="download-app-today-inner"> <img src="assets/img/home-new/up.jpg" alt="" class="up" />
    <div class="download-app-today-text">
      ...
      <span>
          <a href="<?=$IPHONE_APP_LINK?>" target="_blank"><?php if(isset($data[0]['ThirdSectionAPPImgAPPStore']) && (!empty($data[0]['ThirdSectionAPPImgAPPStore']))) { ?><img src="<?=$tconfig["tsite_img"]."/home-new/".$data[0]['ThirdSectionAPPImgAPPStore'];?>" alt="" /><?php } else { ?><img src="assets/img/home-new/app-store.jpg" alt="" /> <?php } ?></a>

          <a href="<?=$ANDROID_APP_LINK?>" target="_blank"><?php if(isset($data[0]['ThirdSectionAPPImgPlayStore']) && (!empty($data[0]['ThirdSectionAPPImgPlayStore']))) { ?><img src="<?=$tconfig["tsite_img"]."/home-new/".$data[0]['ThirdSectionAPPImgPlayStore'];?>" alt="" /><?php } else { ?><img src="assets/img/home-new/play-store.jpg" alt="" /> <?php } ?></a>
      </span>
    </div>
    ...
    <div class="footer-part2">
      ...
      <ul>
       ...
       <li><a href="help-center"><?=$langage_lbl['LBL_FOOTER_HOME_HELP_CENTER']; ?></a></li>
        <li><a href="provider-login">Become Driver</a></li>
      </ul>
    </div>
      ...
      <b>
        ...
        <?php } 
          if(!empty($INSTAGRAM_LINK_FOOTER)){ ?>    
            <a href="<?php echo $INSTAGRAM_LINK_FOOTER;?>" target="_blank" rel="nofollow"><img onmouseout="this.src='assets/img/home-new/pinterest.jpg'" onmouseover="this.src='assets/img/home-new/pinterest-hover.jpg'" src="assets/img/home-new/pinterest.jpg" alt=""></a>
          <?php } ?>
      </b>
      <?php } ?>
    </div>
    <div class="footer-bottom-part">
      <p><span>&copy; <?= $COPYRIGHT_TEXT ?></span> <a href="#">Cubejek</a></p>
    </div>
    <div style="clear:both;"></div>
  </div>
</div>
