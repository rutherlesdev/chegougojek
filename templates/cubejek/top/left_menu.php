                    ...
                    <?php } else if ($user == 'company') { ?>
                        ...
                        <?php if ($eSystem == "DeliverAll") { ?>
                            ...
                            <li><a href="settings" class="<?= (isset($script) && $script == 'Settings') ? 'active' : ''; ?>"><b><i aria-hidden="true" class="fa fa-gear"></i></b><span><?= $langage_lbl['LBL_SETTINGS']; ?></span></a></li>
                            	...
                            	<?php /*<li><a href="javascript:;" onclick="window.location.href = 'user_info.php'"><b><img alt="" src="assets/img/my-trips.png"></b><?php echo $_SESSION['sess_iServiceName_mr']; ?></b></a></li>*/?>
...
<?php if ($user == "") { ?>
                    ...
                    <b>
                        ...
                        <a class="<?= (isset($script) && $script == 'Organization Sign-Up') ? 'active' : ''; ?>" href="organization-login">BECOME AN ORGANIZATION</a></b>
