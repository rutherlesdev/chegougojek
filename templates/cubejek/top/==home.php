...
<section class="download-section" style="background-image:url(<?php  echo $tconfig["tsite_upload_page_images"].'home/'.$data[0]['third_mid_image_two']; ?>);">  
    <div class="download-section-inner">
        ...
        <div class="download-links"> <a href="<?= $ANDROID_APP_LINK ?>" target="_blank"><img alt="" src="assets/img/google-play.png" /></a> <a href="<?= $IPHONE_APP_LINK ?>" target="_blank"><img alt="" src="assets/img/istore.png" /></a> </div>
    </div>
</section>
