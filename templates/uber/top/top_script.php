...
<? if($SITE_VERSION != 'v5') { ?> 
	...
	<? if($host_system == 'cubedelivery'){ ?>
		<link rel="stylesheet" href="assets/css/style_v5_color_delivery.css">
	<? } else { ?>
	...
	<link rel="stylesheet" href="assets/css/style_v5_color-green.css"> 
