            ...
            if ($user != "") {
                ...
                <div class="logo">
                    ...
                    <span class="top-logo-link" >
                        ...
                        <? } else { ?>
                            <a href="profile" class="<?= (isset($script) && $script == 'Profile') ? 'active' : ''; ?>"><?= $langage_lbl['LBL_HEADER_TOPBAR_PROFILE_TITLE_TXT']; ?></a><a href="logout"><?= $langage_lbl['LBL_HEADER_LOGOUT']; ?></a>
                        <? } ?>
                    </span>
                </div> 
                <div class="top-link-login-new">
                    <div class="user-part-login">
                    <?php if($_SESSION['sess_user'] != 'organization') {  ?>
