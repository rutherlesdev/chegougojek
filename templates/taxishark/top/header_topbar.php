...
<header class="<?if($_SESSION['sess_user']!=""){?>LOGGEDIN<?}else{?>LOGGEDOUT<?}?>">
    <div class="header-inner">
        ...
        <div class="dynamic-data">
            ...
            <?php /*<select name="currency" onchange="change_curr(this.value);">
			 <?php
			...
			?>
					<option <?php echo $status_curr; ?> value="<?php echo $currValue['vName']; ?>"><?php echo ucfirst(strtolower($currValue['vName'])); ?></option>
                        <?php } ?>
            </select><?php */?>
        </div>
		<?php if ($user == "") { ?>
