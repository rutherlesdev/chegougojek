        ...
        <div id="main-uber-page">
            ...
            <div class="page-contant">
                <div class="page-contant-inner">
                    ...
                    <!-- trips detail page -->
                    <form name="frmsignup" id="frmsignup" method="post" action="signuprider_a.php" class="clearfix">
                                ...
                                <span class="newrow">
                                   ...
                                   <!--  <div class="relative_ele"> -->
                                        <strong>
                                            ...
                                            <input id="pass" type="password" name="vPassword" placeholder="<?= $langage_lbl['LBL_PASSWORD']; ?>" class="create-account-input create-account-input1" value="" />
                                ...
                                <?php if ($REFERRAL_SCHEME_ENABLE == 'Yes') { ?>
                                    <span class="newrow" style="margin:0px;">
                                        <strong id="refercodeCheck">
                                            <label><?= $langage_lbl['LBL_REFERAL_CODE_SIGNUP']; ?></label>
...
<em class="captcha-abx"><img src="captcha_code_file.php?rand=<?php echo rand(); ?>" id='captchaimg' alt="" class="chapcha-img" />&nbsp;<?= $langage_lbl['LBL_CAPTCHA_CANT_READ_SIGNUP']; ?> <a href='javascript: refreshCaptcha();'><?= $langage_lbl['LBL_CLICKHERE_SIGNUP']; ?></a></em>-->
                                ...
                                <span class="newrow">
                                    <strong class="captcha-signup1">
                                        <div class="checkbox-n checkbox-na">
                                            <input id="c1" name="remember-me" type="checkbox" class="termscheckbox" value="remember">
                                            <label for="c1" class="c1-a"></label>
                                            <abbr><?= $langage_lbl['LBL_SIGNUP_Agree_to']; ?> <a href="terms_condition.php" target="_blank"><?= $langage_lbl['LBL_TERMS_AND_CONDITION']; ?></a></abbr>
                                        </div>   
        ...
        <script>
                                            ...
                                            function check_verification(request_type)
                                            {
                                                if (request_type == 'send') {
                                                    ...
                                                    code = $("#vCode1").val();
                                                    if (code == '') {
                                                        $("#verification_error").html('<i class="icon icon-remove alert" style="display:inline-block;color:red;padding:0px;"><?= addslashes($langage_lbl['LBL_ENTER_VERIFICATION_CODE']); ?></i>');
                                                        return false;
                                                    }
                                                }
                                                phone = $("#vPhone").val();
                                                ...
                                                var request = $.ajax({
                                                    ...
                                                    success: function (data)
                                                    {
                                                        ...
                                                        if (data['type'] == 'send') {
                                                            if (data['action'] == 0)
                                                            {
                                                                $("#mobileCheck").html('<i class="icon icon-remove alert-danger alert"><?= addslashes($langage_lbl['LBL_MOBILE_EXIST']); ?></i>');
                                                                $("#mobileCheck").show();
                                                            ...
                                                            if (data['0'] == 1) {
                                                                ...
                                                                $("#verification_error").html('');
                                                                $("#verification_error").html('<i class="icon icon-remove alert" style="display:inline-block;color:red;" ><?= addslashes($langage_lbl['LBL_INVALID_VERIFICATION_CODE_ERROR']); ?></i>');
                                                            } else {
                                                                $("#verification_error").html('');
                                                                $("#verification_error").html('<i class="icon icon-remove alert" style="display:inline-block;color:red;"><?= addslashes($langage_lbl['LBL_VERIFICATION_ERROR_MSG']); ?></i>');
                                                            }
                                                        }
                                                    }
                                                });
