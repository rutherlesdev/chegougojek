                    ...
                    <div class="login-form">
                        ...
                        <div class="login-form-left"> <form action="<?= $action_url ?>" class="form-signin" method ="post" id="login_box" onSubmit="return chkValid('<?= $action ?>', '<?= $iscompany ?>');" >
                                <b>
                                    ...
                                    <input name="vEmail" type="text" placeholder="<?= $langage_lbl['LBL_ENTER_EMAIL_ID_OR_MOBILE_TXT']; ?>" class="login-input" id="vEmail" value="<?= (SITE_TYPE == 'Demo') ? (($action == 'rider') ? $rider_email : $driver_email) : ''; ?>" required />
                                    <div class="mobile-info" style="margin: 0 0 15px 0;font-size: 11px;color: #666;font-weight: normal;"><?= $langage_lbl['LBL_SIGN_IN_MOBILE_EMAIL_HELPER'] ?></div>
                                </b>
                            ...
                            <form action="" method="post" class="form-signin" id="frmforget" onSubmit="return forgotPass();" style="display: none;">
                                ...
                                <input type="hidden" name="iscompany" id="iscompany" value="<?= $iscompany; ?>">
                                <b>
                        ...
                        <div class="login-form-right login-form-right1">
                            ...
                            <? if (ONLYDELIVERALL != 'No' && $iscompany != "1") { ?>
                                <div class="login-form-right1-inner">
                                    <span><a class="company-av" href="<?= ($action == 'rider') ? $sign_up_rider : $cjSignupCompany; ?>"><?
                                            if (($action == 'driver' && $iscompany == "1")) {
                            ...
                            if (ONLYDELIVERALL == 'Yes' || DELIVERALL == 'Yes') {
                                if (($action == 'driver' && $iscompany == "1")) {
                                    ...
                                    <div class="login-form-right1-inner-new">	
                                        <span><a class="company-av" href="<?= $cjSignupRestaurant; ?>"><?= $langage_lbl['LBL_LOGIN_NEW_SIGN_UP_STORE']; ?></a></span> 
                                    </div>
                                    <?
                                }
                            }
                            ...
                            <? if ($iscompany == "0") { ?>
                                <div class="login-form-right1-inner">
                                    ...
                                    <?php
                                    if ($action == 'driver') {
                                        if ($DRIVER_TWITTER_LOGIN == "Yes" || $DRIVER_GOOGLE_LOGIN == "Yes" || $DRIVER_FACEBOOK_LOGIN == "Yes" || $DRIVER_LINKEDIN_LOGIN == "Yes") {
                                            ?>
                                            <h3><?= $langage_lbl['LBL_REGISTER_WITH_ONE_CLICK']; ?></h3>
                                        <?php } ?>
                                        <span class="login-socials">
                                            <?php if ($DRIVER_FACEBOOK_LOGIN == "Yes") { ?>						
                                                <a href="facebook/<?= $action ?>" class="facebook-new"><img src="assets/img/facebook-new.png"></a>
                                            <?php } if ($DRIVER_TWITTER_LOGIN == "Yes") { ?>

                                                <a href="twitter/<?= $action ?>" class="facebook-new"><img src="assets/img/twitter-new.png"></a>
                                            <?php } if ($DRIVER_GOOGLE_LOGIN == "Yes") { ?>

                                                <a href="google/<?= $action ?>" class="facebook-new"><img src="assets/img/google-new.png"></a>
                                            <?php } if ($DRIVER_LINKEDIN_LOGIN == "Yes") { ?> 
                                                <a href="linkedin/<?= $action ?>"  class="facebook-new"><img src="assets/img/Linkedin-new.png"></a>
                                            <?php } ?>
                                    ...
                                    if ($action == 'rider') {
                                        if ($PASSENGER_FACEBOOK_LOGIN == "Yes" || $PASSENGER_TWITTER_LOGIN == "Yes" || $PASSENGER_GOOGLE_LOGIN == "Yes" || $PASSENGER_LINKEDIN_LOGIN == "Yes") {
                                            ?>
                                            <h3><?= $langage_lbl['LBL_REGISTER_WITH_ONE_CLICK']; ?></h3>
                                        <?php } ?>
                                        <span class="login-socials">
                                            <?php if ($PASSENGER_FACEBOOK_LOGIN == "Yes") { ?>
                                                ...
                                                <a href="facebook-rider/<?= $action ?>" class="facebook-new"><img src="assets/img/facebook-new.png"></a>
                                                <?php
                                            }
                                            ...
                                            <?php } if ($PASSENGER_LINKEDIN_LOGIN == "Yes") { ?>
                                                ...
                                                <a href="linkedin-rider/<?= $action ?>"  class="facebook-new"><img src="assets/img/Linkedin-new.png"></a>
                                            <?php } ?>
                            ...
                            if (login_status == 1) {
                                ...
                                if (login_type == 'rider' && departType == 'mobi')
                                    ...
                                    if (url != null) {
                                        ...
                                        <?php if(isset($_COOKIE['login_redirect_url_user'])) { ?>
                                            url = '<?php echo $_COOKIE["login_redirect_url_user"] ?>';
                                        <?php } ?>
                                        window.location = url;
                                    } else {
