...
if ($user == 'company') {
    ...
    $sql = "SELECT dm.doc_masterid masterid, dm.doc_usertype ,dm.doc_name_" . $_SESSION['sess_lang'] . "  as d_name , dm.doc_name ,dm.ex_status,dm.status, dl.doc_masterid masterid_list ,dl.ex_date,dl.doc_file , dl.status, dm.eType FROM document_master dm left join (SELECT * FROM `document_list` where doc_userid='" . $_SESSION['sess_iUserId'] . "' ) dl on dl.doc_masterid=dm.doc_masterid where dm.doc_usertype='".$docType."' and dm.status='Active' and (dm.country ='" . $db_user[0]['vCountry'] . "' OR dm.country ='All')";
            ...
            if ($user == 'company') {
                if (SITE_TYPE == 'Demo') {
                    ?><div class="demo-warning" style="width: 100%; margin-bottom:30px;">
                        <? if ($docType == "company") { ?><p><?= $langage_lbl['LBL_WE_SEE_YOU_HAVE_REGISTERED_AS_A_COMPANY']; ?></p><? } ?>
                        ...
                        <p>- <?= $langage_lbl['LBL_STEP1_DL_DEMO']; ?></p>
                        <p>- <?= $langage_lbl['LBL_STEP3_DL_DEMO']; ?></p>
                        <p>- <?= $langage_lbl['LBL_STEP2_DL_DEMO']; ?></p>
                        <? } ?>
                    </div>
                <? } else { ?>
                    <div class="demo-warning"  style="width: 100%; margin-bottom:30px;">
        ...
        <div class="profile-caption">
            ...
            <?php if ($success ==1) { ?>
                <div class="alert alert-success" style="width: 100%;margin: 0px 0 30px 0;">
                    ...
                    <?php $var_msg = ($var_msg != "") ? $var_msg : $langage_lbl['LBL_PROFILE_UPDATED'];  
                          echo $var_msg;
                    ?>
                </div>
                <?php }
            ...
            <div class="profile-block">             
                <div class="profile-caption-header">
                    <label><?= $langage_lbl['LBL_HELLO'].", ".$generalobj->cleanall(htmlspecialchars($db_user[0]['vCompany'])) . ' ' . $generalobj->cleanall(htmlspecialchars($db_user[0]['vLastName'])); ?></label>
                                    ...
                                    <div class="partation">
                                        <h1><?= $langage_lbl['LBL_PROFILE_ADDRESS']; ?></h1>
                                            ...
                                            <div class="form-group half newrow">
                                                ...
                                                <input type="text" class="profile-address-input" value="<?= $generalobj->cleanall(htmlspecialchars($db_user[0]['vCaddress'])); ?>" name="address1"  <?php if ($user == 'company') { ?>required<? } ?> >
                                            </div>
				...
				<?php if($SHOW_CITY_FIELD=='Yes') { ?>
				    ...
				    <?php } ?>
                                            ...
                                            <div class="form-group half newrow">
                                                <label>Zip  <?php if ($user == 'company') { ?><span class="red">*</span><? } ?></label>
                                                <input type="text" class="profile-address-input" value="<?= $db_user[0]['vZip'] ?>" name="vZipcode" <?php if ($user == 'company') { ?> required <? } ?>>
                                            </div>
                                        </div>
                                ...
                                <div class="upload-block">
                                    <div class="panel panel-default upload-clicking">
                                        ...
                                        <strong>
                                            ...
                                            <?php if (($APP_TYPE == 'Ride-Delivery' || $APP_TYPE == 'Ride-Delivery-UberX') && $user == 'driver') { ?>
                                            <?php } ?>
                                        </strong>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="model-body fileupload fileupload-new" data-provides="fileupload">
                                            ...
                                            <div>
                                                ...
                                                <a href="#" class="gen-btn fileupload-exists" data-dismiss="fileupload" onclick="change_img('<?= $img_path . '/' . $_SESSION['sess_iUserId'] . '/2_' . $db_data[0]['vImage']; ?>')">Close</a>
                                            </div>
        ...
        <script type="text/javascript">
					...
					var usertype = '<?php echo $docType; ?>';
                                                    ...
                                                    $.ajax({
                                                        ...
                                                        data: 'rowid=' + idVal + '-' + id + '-' + user + '-' + usertype, //Pass $id
