...
<body class="padTop53 " >
    ...
    <div id="wrap">
        ...
        <div id="content">
            <div class="inner">
				<div class="row">
					<div class="col-lg-12">
						<h2><?=$langage_lbl['LBL_CAR_FAQ_CAT_ADMIN']; ?></h2>
							...
							<div class="col-lg-12">
								<div class="panel panel-default">
									<div class="panel-heading">
										<?=$langage_lbl['LBL_FAQ_CATEGORIES']; ?>
									</div>
									<div class="panel-body">
										<div class="table-responsive">
											<table class="table table-striped table-bordered table-hover" id="dataTables-example">
												<thead>
													<tr>
														<th><?=$langage_lbl['LBL_IMAGE'];?></th>
														<th><?=$langage_lbl['LBL_TITLE_TXT_ADMIN'];?></th>
														<th><?=$langage_lbl['LBL_ORFER'];?></th>
														<th><?=$langage_lbl['LBL_Status'];?></th>
														<th><?=$langage_lbl['LBL_PROFILE_EDIT'];?></th>
    ...
    <script>
         $(document).ready(function () {
             $('#dataTables-example').dataTable( {"oLanguage": langData,"bSort": false } );
         });
    </script>
</body>
	<!-- END BODY-->    
