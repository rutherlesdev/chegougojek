...
<?php include_once("top/header_topbar.php"); ?>
            ...
            <div class="page-contant">
                <div class="page-contant-inner">
                    ...
                    <!-- trips detail page -->
                    <form name="frmsignup" id="frmsignup" method="post" action="signup_a.php" class="clearfix">
...
<? //if(ONLYDELIVERALL != 'Yes') {  ?>
                            <div class="individual-driver">
                                ...
                                <span>
                                    ...
                                    <div class="radio-but"> 
                                        <b>
                                            <input id="r1" name="user_type" type="radio" value="driver" <?php
                                            if ($user_type == 'driver') {
                                                echo 'checked';
                                            }
                                            ?> onChange="show_company(this.value);" checked="checked">
                                            <label for="r1"><?= $langage_lbl['LBL_SIGNUP_INDIVIDUAL_DRIVER']; ?></label>
                                        </b> 
                                        <b>
                                            <input id="r2" name="user_type" type="radio" value="company" <?php
                                            if ($user_type == 'company') {
                                                echo 'checked';
                                            }
                                            ?> onChange="show_company(this.value);" class="">
                                            <label for="r2"><?= $langage_lbl['LBL_COMPANY_SIGNIN']; ?></label>
                                        </b> 
                                    </div>
                                </span> 
                            </div>
...
<?php if ($REFERRAL_SCHEME_ENABLE == 'Yes') { ?>
                                    <span class="newrow"><strong id="refercodeCheck">
                                            <label id="referlbl"><?= $langage_lbl['LBL_REFERAL_CODE_SIGNUP']; ?></label>
                                            <input id="vRefCode" type="text" name="vRefCode" placeholder="<?= $langage_lbl['LBL_SIGNUP_REFERAL_CODE']; ?>" class="create-account-input create-account-input1 vRefCode_verify" value="<?php echo $vRefCode; ?>" onBlur="validate_refercode(this.value)"/></strong></span> 
<?php } ?>
...
<?php } ?>
                                    <strong><label><?= $langage_lbl['LBL_ADDRESS_SIGNUP']; ?><span class="red company">*</span> </label>
                                ...
                                <span class="newrow">
                                    <strong><label><?= $langage_lbl['LBL_ZIP_CODE_SIGNUP']; ?><span class="red company" >*</span></label>
        ...
        <script type="text/javascript">
                                            ...
                                            $('#frmsignup').validate({
                                                ...
                                                messages: {
                                                    ...
                                                    //'g-recaptcha-response' : { required: 'This field required.'}
                                                    /* old recaptcha code */
