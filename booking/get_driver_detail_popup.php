...
<ul class="<?php echo $db_driver['iDriverId']; ?>">
	<li>
		...
		<label><b><?php echo $langage_lbl_admin['LBL_DRIVER_TXT']; ?> :</b><?php echo $generalobj->clearName($db_driver['FULLNAME']); ?></label>
		<label><b><?php echo $langage_lbl_admin['LBL_DRIVER_TXT']."&nbsp;".$langage_lbl_admin['LBL_EMAIL_TEXT']; ?> :</b><?php echo $generalobj->clearEmail($db_driver['vEmail']); ?></label>
		<label><b>Phone No :</b>+<?php echo $generalobj->clearMobile($db_driver['vCode'].$db_driver['vPhone']); ?></label>
	</li>
	...
	<li>
		...
		<label><b><?php echo $langage_lbl_admin['LBL_RIDER_NAME_TXT_ADMIN']; ?> :</b><?php echo $generalobj->clearName($db_cust['FullName']); ?></label>
		<label><b>Phone No :</b>+<?php echo $db_cust['vPhoneCode']; ?><?php echo $generalobj->clearPhone($db_cust['vPhone']); ?></label>
	</li>
