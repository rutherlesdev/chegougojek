...
function ChargeCustomer($Data, $eChargeEvent = "CollectPayment") {
    ...
    if ($UserType == "Passenger") {
        ...
        $iUserId = "iUserId";
        /* Added By PM On 09-12-2019 For Flutterwave Code Start */
        $UserDetailPaymaya = get_value($tbl_name, 'vPaymayaCustId,vSenangToken,vPaymayaToken,vAdyenToken,vName,vLastName,vEmail,vPhone,vXenditAuthId,vXenditToken,vFlutterWaveToken,vCurrencyPassenger as vCurrency', $iUserId, $iMemberId);
        /* Added By PM On 09-12-2019 For Flutterwave Code End */
    } else {
        $tbl_name = "register_driver";
        $iUserId = "iDriverId";
        /* Added By PM On 09-12-2019 For Flutterwave Code Start */
        $UserDetailPaymaya = get_value($tbl_name, 'vPaymayaCustId,vSenangToken,vPaymayaToken,vAdyenToken,vName,vLastName,vEmail,vPhone,vXenditAuthId,vXenditToken,vFlutterWaveToken,vCurrencyDriver as vCurrency', $iUserId, $iMemberId);
        /* Added By PM On 09-12-2019 For Flutterwave Code End */
    }
