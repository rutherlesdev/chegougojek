        ...
        <div class="profile-caption">
            ...
            <div class="profile-section">
                            ...
                            <input type="hidden" name="backlink" id="backlink" value="menuitems.php"/>
                                ...
                                <div class="partation" >
                                    ...
                                    <div class="form-group half">
                                        ...
                                        <select   name = 'iFoodMenuId' required onChange="changeDisplayOrder(this.value, '<?php echo $id; ?>');" >
				...
				<span id="showDisplayOrder001">
                                        ...
                                        for ($i = 0; $i < $count_all; $i++) {
                                            ...
                                            <div class="half-column">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"  name="<?= $vValue; ?>" id="<?= $vValue; ?>" value="<?= $$vValue; ?>" <?= $required; ?>>

                                                </div>
                                                <? if($vCode == $default_lang  && count($db_master) > 1){ ?>
                                                        <div class="col-lg-6" style="margin-top: -16px;padding: 8px;">
                                                            <button type ="button" name="allLanguage" id="allLanguage" class="btn btn-convert-all" onClick="getAllLanguageCode('vItemType_');"><?php echo $langage_lbl['LBL_MENU_ITEM_FRONT'] ?> Convert To All Language</button>
                                                        </div>
                                                    <?php } ?>

                                                    <? if($vCode == 'PT'  && count($db_master) > 1){ 
                                                        $style=" style='margin-top:47px;'";
                                                     } ?>
                                                <div class="form-group" <?= $style?>>
                                                    
                                                    <label  ><?php echo $langage_lbl['LBL_MENU_ITEM_DESCRIPTION'] ?>(<?= $vTitle; ?>)</label>
                                                    <textarea  name="<?= $vValue_desc; ?>" id="<?= $vValue_desc; ?>" ><?= $$vValue_desc; ?>
                                                    </textarea>
                                                </div>
                                                <? if($vCode == $default_lang  && count($db_master) > 1){ ?>
                                                        <div class="col-lg-6" style="margin-top: -16px;padding: 8px;">
                                                            <button type ="button" name="allLanguage" id="allLanguage" class="btn btn-convert-all" onClick="getAllLanguageCode('vItemDesc_');"><?php echo $langage_lbl['LBL_MENU_ITEM_DESCRIPTION'] ?> Convert To All Language</button>
                                                        </div>
                                                    <?php } ?>
                                        ...
                                        <div class="imageupload">
                                            ...
                                            <div class="file-tab">
                                                ...
                                                <div>
                                                    ...
                                                    <input name="vImage" onchange="preview_mainImg(event);" type="file"  <?= ($id=='' || ($id != '' && $eRecommended == 'Yes')) ? 'required' : ''; ?>></div>
                                                                    ...
                                                                    <div class="form-group eDefault"> 
                                                                        ...
                                                                        <div class="col-sm-5">
                                                                            ...
                                                                            <div class="form-group"> 
                                                                                ...
                                                                                <input type="text"  id="BaseOptions" name="BaseOptions[]" required="required" value="<?= $option['vOptionName'] ?>" placeholder="Option Name" >
                                                                    ...
                                                                    <div class="form-group removeclass<?= $opt ?>"> 
                                                                        ...
                                                                        <div class="col-sm-5">
                                                                            ...
                                                                            <div class="form-group"> 
                                                                                ...
                                                                                <input type="text"  id="OptPrice" name="OptPrice[]" required="required" value="<?= $option['fPrice'] ?>" placeholder="Price">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="input-group">
                                                                                    ...
                                                                                    <div class="input-group-btn"> 
                                                                                        ...
                                                                                        <i onclick="remove_options_fields('<?= $opt ?>');"> <span class="icon-cancel" aria-hidden="true"></span></i>
                                                                ...
                                                                <div class="form-group removeclassaddon<?= $a ?>"> 
                                                                    ...
                                                                    <div class="col-sm-5">
                                                                        ...
                                                                        <div class="form-group"> 
                                                                            ...
                                                                            <input type="text"  id="AddonOptions" name="AddonOptions[]" value="<?= $addon['vOptionName'] ?>" placeholder="Topping Name" required>
                                                                    ...
                                                                    <div class="col-sm-5">
                                                                        ...
                                                                        <div class="form-group"> 
                                                                            ...
                                                                            <input type="text"  id="AddonPrice" name="AddonPrice[]" value="<?= $addon['fPrice'] ?>" placeholder="Price" required>
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="input-group">
                                                                                ...
                                                                                <div class="input-group-btn"> 
                                                                                    ...
                                                                                    <i onclick="remove_addon_fields('<?= $a ?>');"> <span class="icon-cancel" aria-hidden="true"></span></i>
                                    ...
                                    <div class="form-group half" <?php if ($iServiceId != '1') { ?> style="display:none;" <?php } ?>>

                                        <strong><?= $langage_lbl['LBL_FOOD_TYPE'] ?><span class="red">*</span></strong>

                                        <select  name="eFoodType"  id="eFoodType">
                                    ...
                                    <div class="half-column" style="display:<?php if ($prescriptionchkbox_required == 'Yes') { ?>block<?php } else { ?>none<?php } ?>">
                                        ...
                                        <div class="toggle-list-inner">
                                            ...
                                            <div class="toggle-combo">
                                                ...
                                                <label><?php echo $langage_lbl_admin['LBL_IS_PRESCRIPTION_REQUIRED'] ?> <i class="icon-question-sign" data-placement="top" data-toggle="tooltip" data-original-title="Suggest the user's to order this item. The recommended items will be highlighted in the user app with the image and display at the top section"></i></label>
                                ...
                                ?>
                                <input type="submit" class="gen-btn item-submittion" name="btnsubmit" id="btnsubmit" value="<?= $actionbtn; ?> <?php echo $langage_lbl['LBL_MENU_ITEM_FRONT']; ?>" >
    ...
    margin: 10px 0 0 0;
        ...
        function options_fields() {
            ...
            if (optionid == '1') {
                ...
                divtest1.innerHTML = '<div class="col-sm-5"><div class="form-group"> <input type="text"  id="BaseOptions" name="BaseOptions[]" value="' + baseOptionValue + '" placeholder="Option Name" required="required"></div></div><div class="col-sm-5"><div class="form-group"> <input type="text"  id="OptPrice" name="OptPrice[]" required="required" value="' + basePrice + '" placeholder="Price" readonly><input type="hidden" name="OptionId[]" value="" /><input type="hidden" name="optType[]" value="Options" /><input type="hidden" name="eDefault[]" value="Yes"/></div></div><div class="clear"></div>';

                objTo.appendChild(divtest1);



                divtest.innerHTML = '<div class="col-sm-5"><div class="form-group"> <input type="text"  id="BaseOptions" name="BaseOptions[]" required="required" value="" placeholder="Option Name"></div></div><div class="col-sm-5"><div class="form-group"><input type="text"  id="OptPrice" name="OptPrice[]" value="" required="required" placeholder="Price (In <?= $db_currency[0]['vName'] ?>)"><input type="hidden" name="OptionId[]" value="" /><input type="hidden" name="optType[]" value="Options" /><input type="hidden" name="eDefault[]" value="No"/></div></div><div class="col-sm-2 center-align"><div class="form-group"><div class="input-group"><div class="input-group-btn"> <i class="" onclick="remove_options_fields(' + optionid + ');"> <span class="icon-cancel" aria-hidden="true"></span></i></div></div></div></div><div class="clear"></div>';

            } else {

                divtest.innerHTML = '<div class="col-sm-5"><div class="form-group"> <input type="text"  id="BaseOptions" name="BaseOptions[]" value="" required="required" placeholder="Option Name"></div></div><div class="col-sm-5"><div class="form-group"><input type="text"  id="OptPrice" name="OptPrice[]" value="" required="required" placeholder="Price (In <?= $db_currency[0]['vName'] ?>)" ><input type="hidden" name="OptionId[]" value="" /><input type="hidden" name="optType[]" value="Options" /><input type="hidden" name="eDefault[]" value="No"/></div></div><div class="col-sm-2 center-align"><div class="form-group"><div class="input-group"><div class="input-group-btn"> <i onclick="remove_options_fields(' + optionid + ');"> <span class="icon-cancel" aria-hidden="true"></span></i></div></div></div></div><div class="clear"></div>';
        ...
        function addon_fields() {
            ...
            divtest.innerHTML = '<div class="col-sm-5"><div class="form-group"> <input type="text" id="AddonOptions" name="AddonOptions[]" value="" placeholder="Topping Name" required></div></div><div class="col-sm-5"><div class="form-group"> <input type="text" id="AddonPrice" name="AddonPrice[]" value="" placeholder="Price (In <?= $db_currency[0]['vName'] ?>)" required><input type="hidden" name="addonId[]" value="" /><input type="hidden" name="optTypeaddon[]" value="Addon" /></div></div><div class="col-sm-2 center-align"><div class="form-group"><div class="input-group"><div class="input-group-btn"> <i onclick="remove_addon_fields(' + addonid + ');"> <span class="icon-cancel" aria-hidden="true"></span></i></div></div></div></div><div class="clear"></div>';
