...
<div class="upload-content ">
    ...
    <form class="form-horizontal frm6" id="frm6" method="post" enctype="multipart/form-data" action="cx-profile_company.php?id=<?php echo $id[1] ; ?>&master=<?php echo $id[0] ; ?> " name="frm6">
            ...
            <div class="fileupload fileupload-new" data-provides="fileupload">
                <div class="fileupload-preview thumbnail">
                    <?php if ($db_user[0]['doc_file'] == '') { 
                        ...
                        if ($file_ext == 'is_image') { ?>
                            <img src = "<?= $tconfig["tsite_upload_compnay_doc"]. '/' . $id[1] . '/' . $db_user[0]['doc_file'] ?>" alt ="<?php echo $db_user[0]['doc_name']; ?> not found"/>
                        <?php } else { ?>
                ...
                <div class="newrow">
                    <span class="btn btn-file btn-success gen-btn"><span class="fileupload-new"><?=$langage_lbl['LBL_UPLOAD']; ?> <?php // echo $vName ?> <?=$langage_lbl['LBL_PHOTO']; ?></span>
                        ...
                        <!-- <input type="file" name="driver_doc" id="driver_doc"/></span> -->
                        <input type="file" name="driver_doc"/></span>
                    <a href="#" class="btn btn-danger fileupload-exists gen-btn dismissUpload" data-dismiss="fileupload"><?=$langage_lbl['LBL_REMOVE_TEXT']; ?></a>
        ...
        <div class="model-footer">
            <div class="button-block">
                <input type="submit" class="save gen-btn" name="save" value="<?= $langage_lbl['LBL_Save']; ?>">
