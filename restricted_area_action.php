<?
	...
	if(isset($_POST['submit'])) {
		if($action == "Add" && !$userObj->hasPermission('create-store')){
	        $_SESSION['success'] = 3;
	        $_SESSION['var_msg'] = 'You have not permission to create Restricted Area.';
	        header("Location:restricted_area.php");
	        exit;
	   }

	   if($action == "Edit" && !$userObj->hasPermission('edit-store')){
	        $_SESSION['success'] = 3;
	        $_SESSION['var_msg'] = 'You have not permission to update Restricted Area.';
	        header("Location:restricted_area.php");
	        exit;
	   }
