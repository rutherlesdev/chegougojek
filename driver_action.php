...
if (isset($_POST['submit'])) {
    ...
    if ($id != '') {
        ...
        $checkEditProfileStatus = $generalobj->getEditDriverProfileStatus($edit_data[0]['eStatus']);
...
?>
                                                ...
                                                <input type="text" class="driver-action-page-input" name="vName" <?= $readOnly ?>   id="vName" value="<?= $generalobj->cleanall(htmlspecialchars($vName)); ?>" placeholder="<?= $langage_lbl['LBL_YOUR_FIRST_NAME']; ?>" required>
                                        ...
                                        <div class="col-md-6">
                                            <span>
                                                ...
                                                <input type="text" class="driver-action-page-input" name="vLastName" <?= $readOnly ?>  id="vLastName" value="<?= $generalobj->cleanall(htmlspecialchars($vLastName)); ?>" placeholder="<?= $langage_lbl['LBL_YOUR_LAST_NAME']; ?>" required>
...
<?php if ($SHOW_CITY_FIELD == "Yes") { ?>
                                        ...
                                        <div class="action-driv"> 
                                            ...
                                            <div class="col-md-8"> 
                                                <span>
                                                    ...
                                                    <input type="text" class="driver-action-page-input" name="vCaddress"  id="vCaddress" value="<?= $generalobj->cleanall(htmlspecialchars($vCaddress)); ?>" placeholder="<?= $langage_lbl['LBL_PROFILE_ADDRESS']; ?>">
    ...
    <?php if ($generalobj->CheckUfxServiceAvailable() == "Yes") { ?>
                                            <div class="action-driv">
                                                <div class="col-md-6">
                                                    <span>
