...
$_SESSION['fb_user'] = 'Driver';
// init app with app id and secret
// echo "<pre>"; print_r($_SESSION); die;
FacebookSession::setDefaultApplication( $appId ,$appsecretkey );
// login helper with redirect_uri
//changed by SP to change url to https
    if (strpos($tconfig['tsite_url'], 'https') !== false) { } else {
        $tconfig['tsite_url'] = str_replace('http','https',$tconfig['tsite_url']);
    }
