        ...
        <div class="profile-section-inner ">
          ...
          <form id="food_category_form" class="general-form" name="food_category_form" method="post" action="" enctype="multipart/form-data">
                ...
                <div class="half-column">
                    ...
                    <? if($vCode == $default_lang  && count($db_master) > 1){ ?>
                            <div class="col-lg-6" style="margin-top: -16px;padding: 8px;">
                                <button type ="button" name="allLanguage" id="allLanguage" class="btn btn-convert-all" onClick="getAllLanguageCode('vMenu_');"> Convert To All Language</button>
                            </div>
                        <?php } ?>
                </div>  
                <?php } else { ?>
                    <div class="form-group half">
                        <label>sdfsdf<?php echo $langage_lbl['LBL_MENU_CATEGORY_WEB_TXT'];?> (<?=$vTitle;?>) <?php echo $required_msg;?></label>  
                        <input type="text" name="<?=$vValue;?>" id="<?=$vValue;?>" value="<?=$$vValue;?>" <?=$required;?>> 
                    </div>
              <? } }
            } ?>
            ...
            <div class="button-block">
                <input type="submit" class="gen-btn" name="submit" id="submit" value="<?= $action; ?> <?php echo $langage_lbl['LBL_FOOD_ADMIN'];?>" >
              </div>
              </div>
          </form>
          </div>
