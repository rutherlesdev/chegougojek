...
if($generalobj->checkXThemOn() == 'Yes') {
        include_once("cx-add_availability.php");
        exit;
}
	    			...
	    			<div class="car-type add-car-services-hatch add-services-hatch add-services-taxi colums-view">   
			          	<ul>
							...
							<li>
									...
									<div class="small_box">
										<input class="small_box-a" type='checkbox' name='<?php echo $name;?>[<?php echo $dayname;?>][]' value='<?php echo $value;?>' <?php if(!empty($check_data) && in_array($value,$check_data)){?>checked<?php } ?>><?php echo $hours_display[$key];?>
									</div>
									</label><?php } ?>
							</li>
							</fieldset>
