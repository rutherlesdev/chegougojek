...
$selectcuisine_sql = "SELECT cuisineId,cuisineName_".$cuisineLang." as cuisineName FROM  `cuisine` WHERE iServiceId='".$iServiceId."' AND eStatus = 'Active'";
                    ...
                    <form method="post" action="" class="company_form general-form" id="company_form" enctype="multipart/form-data">
                        ...
                        <div class="partation">
                            ...
                            <div class="form-group half half-new ">
                                <strong><?=$langage_lbl['LBL_ESTIMATED_FOOD_PREPARATION_TIME_TXT']; ?> (<?=$langage_lbl['LBL_IN_MINUTES_TXT']; ?>)<span class="red">*</span></strong>
                            ...
                            <div class="half-column" id="fOfferAmtDiv">
                                <div class="form-group">
                                    <strong><?= $langage_lbl['LBL_OFFER_DISCOUNT_TXT'] ?><span class="addnote" style="float: none;"></span><span class="red"> *</span></strong>
                                    <input type="text" class="" name="fOfferAmt"  id="fOfferAmt" value="<?=$fOfferAmt;?>" >
                                </div>
                            </div>
                            <div class="half-column" id="fMaxOfferAmtDiv">
                                <div class="form-group">
                                    <strong><?= $langage_lbl['LBL_MAX_OFF_AMOUNT'] ?> (In <?=$db_currency[0]['vName']?>) <i class="icon-question-sign" data-placement="top" data-toggle="tooltip" data-original-title='Set the amount to limit user to get the maximum off amount on each order. E.g. If offer is 50% off, and maximum off amount is <?= $db_currency[0]['vSymbol']; ?>250, then on order of <?= $db_currency[0]['vSymbol']; ?>2000 user can get <?= $db_currency[0]['vSymbol']; ?>250 off, but not <?= $db_currency[0]['vSymbol']; ?>1000 off.'></i></strong>
                            ...
                            <div class="half-column half-new">
                                <div class="form-group">
                                    <strong><?= $langage_lbl['LBL_TARGET_AMOUNT_TXT'] ?> (In <?=$db_currency[0]['vName']?>) <i class="icon-question-sign" data-placement="top" data-toggle="tooltip" data-original-title='"Set the minimum total order amount to avail the offer. E.g. "Get <?= $db_currency[0]['vSymbol']; ?>7 off on order above <?= $db_currency[0]['vSymbol']; ?>50" OR "Get 20% off on order above <?= $db_currency[0]['vSymbol']; ?>50", so <?= $db_currency[0]['vSymbol']; ?>50 is the target amount to get the off."'></i> </strong>
                                    <input type="text" class="" name="fTargetAmt"  id="fTargetAmt" value="<?=$fTargetAmt;?>" >
                                        <small class="notes"><span><?php echo $langage_lbl['LBL_NOTE_FRONT']?></span> "If the offer type is 'Flat Offer' then set target amount (<?= $db_currency[0]['vSymbol']; ?>11) greater than offer discount price(<?= $db_currency[0]['vSymbol']; ?>10), Ex. Get <?= $db_currency[0]['vSymbol']; ?>10 off on orders above <?= $db_currency[0]['vSymbol']; ?>11".</small>
                                </div>
                            ...
                            <?php if($iServiceId == '1'){ ?>
                            <div class="form-group half">
                                <strong><?= $langage_lbl['LBL_COST_PER_ORDER'];?> (In <?=$db_currency[0]['vName']?>)<span class="red"> *</span></strong>
                            ...
                            <div class="form-group half">
                                    ...
                                    <select class="" name="eTakeaway">
                                        ...
                                        <option value="Yes" <?php if ($eTakeaway == 'Yes') { echo 'selected'; } ?>><?= $langage_lbl['LBL_BTN_YES_TXT'] ?></option>
                                        <option value="No" <?php if ($eTakeaway == 'No' || $eTakeaway == '') { echo 'selected'; } ?>><?= $langage_lbl['LBL_BTN_NO_TXT'] ?></option>
                                    </select>
                            </div>
                                ...
                                <!--<div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <select class="form-control" name="edeliveryAvailable" id="edeliveryAvailable">
                                            <option value="Yes" <?php if ($edeliveryAvailable == 'Yes') { echo 'selected'; } ?>><?= $langage_lbl['LBL_BTN_YES_TXT'] ?></option>
                                            <option value="No" <?php if ($edeliveryAvailable == 'No') { echo 'selected'; } ?>><?= $langage_lbl['LBL_BTN_NO_TXT'] ?></option>
                                        </select>
                                    </div>
                                </div>-->
                            <? //} ?>
