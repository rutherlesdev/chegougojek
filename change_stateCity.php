...
if(isset($_REQUEST['countryId'])) {
	...
	if($fromMod == ""){
		...
		$cons = "<option value=''>". $langage_lbl['LBL_SELECT_TXT']. " " .$langage_lbl['LBL_STATE_TXT']."</option>";
...
if(isset($_REQUEST['stateId'])) {
	if($fromMod == "")
		...
		$cons = "<option value=''>". $langage_lbl['LBL_SELECT_TXT'] ." ".$langage_lbl['LBL_CITY_TXT']."</option>";
	if($stateId != ""){
