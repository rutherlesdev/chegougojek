...
CKEDITOR.editorConfig = function( config ) {
	...
	// config.uiColor = '#AADC6E';
        ...
        config.removeButtons = 'Save,Checkbox,Radio,TextField,Textarea,HiddenField,Button,ImageButton,Print,Flash,Subscript,Superscript,CopyFormatting,RemoveFormat,Link,Unlink,Anchor,Table,Smiley,Iframe,Templates';
