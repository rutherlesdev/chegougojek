...
/*<div style="width:100%!important;margin-top:0;margin-bottom:0;margin-right:0;margin-left:0;padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;font-family:Arial, Helvetica, sans-serif;">
  <table border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    // Start new adding
    function general_upload_image_vehicle_category_android($temp_name, $image_name, $path, $size1, $size2 = "", $size3 = "", $size4 = "", $option = "", $modulename = "", $original = "", $size5 = "", $temp_gallery, $vehicle_type, $hover) {
    ...
    function general_upload_image_vehicle_category_ios($temp_name, $image_name, $path, $size1, $size2 = "", $size3 = "", $size4 = "", $option = "", $modulename = "", $original = "", $size5 = "", $temp_gallery, $vehicle_type, $hover) {
...
function getTripPriceDetailsForWeb($iTripId, $iMemberId = '', $eUserType = '',$eFrom = '') {
    ...
    $languageLabelsArr = $this->getLanguageLabelsArr($userlangcode, "1");
    ...
    if ($eUserType == "Passenger") {
        ...
        if($eFlatTrip == "Yes" && $iActive != "Canceled") {
            ...
            if($fWalletDebit > $CancelPrice){
              ...
              $subtotal = $this->formatNum($fCancelPrice+$fWaitingFees+$fWalletDebit);
            }
