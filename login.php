  ...
  <div class="tab-content">
    <div id="login" class="tab-pane active">
      <form action="index.html" class="form-signin2 form-login">
        <a href = "login_new.php?action=rider"><?=$langage_lbl['LBL_LOGIN_AS_A_RIDER']; ?></a> <a href = "login_new.php?action=driver" class="login-option-2"><?=$langage_lbl['LBL_LOGIN_AS_A_DRIVER_DL']; ?></a><br>
      </form>
    </div>
  </div>
</div>
