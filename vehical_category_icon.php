...
$catquery = "SELECT iVehicleCategoryId,vHomepageLogo,vCategory_" . $_SESSION['sess_lang'] . " as vehicalcategory FROM `".$sql_vehicle_category_table_name."` WHERE iParentId = 0 and eStatus = 'Active'";
