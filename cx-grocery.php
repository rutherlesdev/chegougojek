...
<head>
    ...
    <title><?=$SITE_NAME?> | <?= $langage_lbl['LBL_HEADER_RDU_GROCERY_APP'] ?></title>
    ...
    <div class="ordernow-inner">
        ...
        <div class="ordernow-right">  
            <div class="ordernow-caption">
                ...
                <a href="<?php echo $call_section['link_EN'];?>" class="book-btn">Order Online</a>
            </div>
        </div>
    </div>
</section>
...
<?php
$tMessage_con = $secure_section['desc_'.$vCode];
$tMessage_con = str_replace($key_arr, $val_arr, $tMessage_con); ?>
