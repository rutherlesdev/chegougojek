...
/* Cron Log Update */
$myfile = fopen($tconfig['tpanel_path']."webimages/script_files/cron_schedule_ride_new_status.txt", "w");
...
function sendRequest($cabId) {
    ...
    if (count($data_booking) > 0) {
        ...
        $Data = getOnlineDriverArr($vSourceLatitude, $vSourceLongitude, "", "", "Yes", "No", "", $vDestLatitude, $vDestLongitude);
