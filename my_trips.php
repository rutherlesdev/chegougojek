...
<!--[if !IE]><!--> <html lang="en" dir="<?= (isset($_SESSION['eDirectionCode']) && $_SESSION['eDirectionCode'] != "") ? $_SESSION['eDirectionCode'] : 'ltr'; ?>"> <!--<![endif]-->
    ...
    <head>
        <meta charset="UTF-8" />
        <title><?= $SITE_NAME ?> | <?= $langage_lbl['LBL_HEADER_TOPBAR_TRIPS_TEXT']; ?></title>
    ...
    <body class="padTop53 " >
            ...
            <div id="content">
                <div class="inner" id="page_height" style="">
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            <h2><?= $langage_lbl['LBL_HEADER_TOPBAR_TRIPS_TEXT']; ?></h2>
                        </div>
                    </div>
                    <hr />
                    <div class="row">
        ...
        <script>
            $(document).ready(function () {
                $('#dataTables-example').dataTable({"oLanguage": langData});
            });
